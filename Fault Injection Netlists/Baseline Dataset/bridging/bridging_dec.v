...
module dec(\count[0] , \count[1] , \count[2] , \count[3] , \count[4] ,
  ...
  // __INJECTED_FAULT__ type=bridging nets=(\selectp2[9],\selectp1[102])
  assign \selectp2[9] = \selectp1[102];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[85],\selectp2[114])
  assign \selectp1[85] = \selectp2[114];
  // __INJECTED_FAULT__ type=bridging nets=(\count[1],\selectp1[54])
  assign \count[1] = \selectp1[54];
  // __INJECTED_FAULT__ type=bridging nets=(n288,\selectp2[42])
  assign n288 = \selectp2[42];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[26],\selectp1[14])
  assign \selectp1[26] = \selectp1[14];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp2[77],\selectp2[110])
  assign \selectp2[77] = \selectp2[110];
  // __INJECTED_FAULT__ type=bridging nets=(n326,\selectp2[22])
  assign n326 = \selectp2[22];
  // __INJECTED_FAULT__ type=bridging nets=(n304,\selectp2[95])
  assign n304 = \selectp2[95];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp2[36],\selectp2[57])
  assign \selectp2[36] = \selectp2[57];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp2[107],n535)
  assign \selectp2[107] = n535;
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[59],\selectp1[62])
  assign \selectp1[59] = \selectp1[62];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp2[122],\selectp2[99])
  assign \selectp2[122] = \selectp2[99];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp2[94],\selectp2[93])
  assign \selectp2[94] = \selectp2[93];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[68],\selectp2[30])
  assign \selectp1[68] = \selectp2[30];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[37],n_16)
  assign \selectp1[37] = n_16;
  // __INJECTED_FAULT__ type=bridging nets=(n_16,\selectp2[73])
  assign n_16 = \selectp2[73];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp2[62],\selectp1[111])
  assign \selectp2[62] = \selectp1[111];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp2[66],\selectp2[37])
  assign \selectp2[66] = \selectp2[37];
  // __INJECTED_FAULT__ type=bridging nets=(n281,\selectp1[15])
  assign n281 = \selectp1[15];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp2[90],\selectp2[6])
  assign \selectp2[90] = \selectp2[6];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[37],\selectp1[76])
  assign \selectp1[37] = \selectp1[76];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[4],n309)
  assign \selectp1[4] = n309;
  // __INJECTED_FAULT__ type=bridging nets=(\selectp2[22],n300)
  assign \selectp2[22] = n300;
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[55],n298)
  assign \selectp1[55] = n298;
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[35],\selectp1[90])
  assign \selectp1[35] = \selectp1[90];
  // __INJECTED_FAULT__ type=bridging nets=(n_11,n283)
  assign n_11 = n283;
  // __INJECTED_FAULT__ type=bridging nets=(n344,\selectp1[19])
  assign n344 = \selectp1[19];
  // __INJECTED_FAULT__ type=bridging nets=(n308,n268)
  assign n308 = n268;
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[88],\selectp2[107])
  assign \selectp1[88] = \selectp2[107];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp2[121],\selectp1[1])
  assign \selectp2[121] = \selectp1[1];
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[53],n275)
  assign \selectp1[53] = n275;
  // __INJECTED_FAULT__ type=bridging nets=(\selectp1[84],\selectp1[1])
  assign \selectp1[84] = \selectp1[1];
endmodule
