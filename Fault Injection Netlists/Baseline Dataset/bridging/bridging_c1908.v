...
module c1908(N1, N4, N7, N10, N13, N16, N19, N22, N25, N28, N31, N34,
  ...
  not g51 (N923, N926);
  // __INJECTED_FAULT__ type=bridging nets=(N2570,N2690)
  assign N2570 = N2690;
  // __INJECTED_FAULT__ type=bridging nets=(N2886,N2024)
  assign N2886 = N2024;
  // __INJECTED_FAULT__ type=bridging nets=(N1855,N1433)
  assign N1855 = N1433;
  // __INJECTED_FAULT__ type=bridging nets=(N99,N2727)
  assign N99 = N2727;
  // __INJECTED_FAULT__ type=bridging nets=(N2850,N1809)
  assign N2850 = N1809;
  // __INJECTED_FAULT__ type=bridging nets=(N655,N2862)
  assign N655 = N2862;
  // __INJECTED_FAULT__ type=bridging nets=(N899,N1221)
  assign N899 = N1221;
  // __INJECTED_FAULT__ type=bridging nets=(N1129,N37)
  assign N1129 = N37;
  // __INJECTED_FAULT__ type=bridging nets=(N209,N1638)
  assign N209 = N1638;
  // __INJECTED_FAULT__ type=bridging nets=(N1159,N1495)
  assign N1159 = N1495;
  // __INJECTED_FAULT__ type=bridging nets=(N2723,N2632)
  assign N2723 = N2632;
  // __INJECTED_FAULT__ type=bridging nets=(N550,N1852)
  assign N550 = N1852;
  // __INJECTED_FAULT__ type=bridging nets=(N253,N69)
  assign N253 = N69;
  // __INJECTED_FAULT__ type=bridging nets=(N220,N1495)
  assign N220 = N1495;
  // __INJECTED_FAULT__ type=bridging nets=(N2815,N1157)
  assign N2815 = N1157;
  // __INJECTED_FAULT__ type=bridging nets=(N612,N2253)
  assign N612 = N2253;
  // __INJECTED_FAULT__ type=bridging nets=(N1130,N2782)
  assign N1130 = N2782;
  // __INJECTED_FAULT__ type=bridging nets=(N2861,N2887)
  assign N2861 = N2887;
  // __INJECTED_FAULT__ type=bridging nets=(N1389,N2765)
  assign N1389 = N2765;
  // __INJECTED_FAULT__ type=bridging nets=(N2689,n_83)
  assign N2689 = n_83;
  // __INJECTED_FAULT__ type=bridging nets=(N94,N2661)
  assign N94 = N2661;
  // __INJECTED_FAULT__ type=bridging nets=(N2757,N1399)
  assign N2757 = N1399;
  // __INJECTED_FAULT__ type=bridging nets=(N2564,N1561)
  assign N2564 = N1561;
  // __INJECTED_FAULT__ type=bridging nets=(N1459,N1919)
  assign N1459 = N1919;
  // __INJECTED_FAULT__ type=bridging nets=(N1947,N2821)
  assign N1947 = N2821;
  // __INJECTED_FAULT__ type=bridging nets=(N1309,N2755)
  assign N1309 = N2755;
  // __INJECTED_FAULT__ type=bridging nets=(N1796,N2019)
  assign N1796 = N2019;
  // __INJECTED_FAULT__ type=bridging nets=(n_85,N2734)
  assign n_85 = N2734;
  // __INJECTED_FAULT__ type=bridging nets=(N2881,N206)
  assign N2881 = N206;
  // __INJECTED_FAULT__ type=bridging nets=(N592,N1947)
  assign N592 = N1947;
  // __INJECTED_FAULT__ type=bridging nets=(N2664,N1206)
  assign N2664 = N1206;
  // __INJECTED_FAULT__ type=bridging nets=(N2742,N1498)
  assign N2742 = N1498;
  // __INJECTED_FAULT__ type=bridging nets=(N1809,N60)
  assign N1809 = N60;
  // __INJECTED_FAULT__ type=bridging nets=(N2661,N2594)
  assign N2661 = N2594;
  // __INJECTED_FAULT__ type=bridging nets=(N2882,N2898)
  assign N2882 = N2898;
  // __INJECTED_FAULT__ type=bridging nets=(N2427,N2223)
  assign N2427 = N2223;
  // __INJECTED_FAULT__ type=bridging nets=(N2673,N1910)
  assign N2673 = N1910;
  // __INJECTED_FAULT__ type=bridging nets=(N1444,N82)
  assign N1444 = N82;
  // __INJECTED_FAULT__ type=bridging nets=(N2214,N1594)
  assign N2214 = N1594;
  // __INJECTED_FAULT__ type=bridging nets=(N94,N1965)
  assign N94 = N1965;
  // __INJECTED_FAULT__ type=bridging nets=(N194,N2874)
  assign N194 = N2874;
  // __INJECTED_FAULT__ type=bridging nets=(N2576,N1740)
  assign N2576 = N1740;
  // __INJECTED_FAULT__ type=bridging nets=(N1350,N893)
  assign N1350 = N893;
  // __INJECTED_FAULT__ type=bridging nets=(N1801,N1773)
  assign N1801 = N1773;
  // __INJECTED_FAULT__ type=bridging nets=(N1884,N2899)
  assign N1884 = N2899;
  // __INJECTED_FAULT__ type=bridging nets=(N1594,N2673)
  assign N1594 = N2673;
  // __INJECTED_FAULT__ type=bridging nets=(N2567,N1412)
  assign N2567 = N1412;
  // __INJECTED_FAULT__ type=bridging nets=(N1438,N1748)
  assign N1438 = N1748;
  // __INJECTED_FAULT__ type=bridging nets=(N2143,N2594)
  assign N2143 = N2594;
  // __INJECTED_FAULT__ type=bridging nets=(N88,N2558)
  assign N88 = N2558;
  // __INJECTED_FAULT__ type=bridging nets=(N1232,N1460)
  assign N1232 = N1460;
endmodule
