...
module c880(N1, N8, N13, N17, N26, N29, N36, N42, N51, N55, N59, N68,
  ...
  not g14 (n_96, N268);
  // __INJECTED_FAULT__ type=bridging nets=(N388,N341)
  assign N388 = N341;
  // __INJECTED_FAULT__ type=bridging nets=(N90,N138)
  assign N90 = N138;
  // __INJECTED_FAULT__ type=bridging nets=(N412,N808)
  assign N412 = N808;
  // __INJECTED_FAULT__ type=bridging nets=(N29,N210)
  assign N29 = N210;
  // __INJECTED_FAULT__ type=bridging nets=(N391,N761)
  assign N391 = N761;
  // __INJECTED_FAULT__ type=bridging nets=(N309,N751)
  assign N309 = N751;
  // __INJECTED_FAULT__ type=bridging nets=(N306,N295)
  assign N306 = N295;
  // __INJECTED_FAULT__ type=bridging nets=(N810,N498)
  assign N810 = N498;
  // __INJECTED_FAULT__ type=bridging nets=(N74,N195)
  assign N74 = N195;
  // __INJECTED_FAULT__ type=bridging nets=(N450,n_96)
  assign N450 = n_96;
  // __INJECTED_FAULT__ type=bridging nets=(N379,N745)
  assign N379 = N745;
  // __INJECTED_FAULT__ type=bridging nets=(N495,N499)
  assign N495 = N499;
  // __INJECTED_FAULT__ type=bridging nets=(N874,N640)
  assign N874 = N640;
  // __INJECTED_FAULT__ type=bridging nets=(n_87,N766)
  assign n_87 = N766;
  // __INJECTED_FAULT__ type=bridging nets=(N335,N644)
  assign N335 = N644;
  // __INJECTED_FAULT__ type=bridging nets=(N737,N143)
  assign N737 = N143;
  // __INJECTED_FAULT__ type=bridging nets=(N219,N745)
  assign N219 = N745;
  // __INJECTED_FAULT__ type=bridging nets=(N42,N682)
  assign N42 = N682;
  // __INJECTED_FAULT__ type=bridging nets=(N323,N849)
  assign N323 = N849;
  // __INJECTED_FAULT__ type=bridging nets=(N302,N385)
  assign N302 = N385;
  // __INJECTED_FAULT__ type=bridging nets=(N270,N697)
  assign N270 = N697;
  // __INJECTED_FAULT__ type=bridging nets=(N13,N860)
  assign N13 = N860;
  // __INJECTED_FAULT__ type=bridging nets=(N219,N319)
  assign N219 = N319;
  // __INJECTED_FAULT__ type=bridging nets=(N644,N842)
  assign N644 = N842;
  // __INJECTED_FAULT__ type=bridging nets=(N600,N506)
  assign N600 = N506;
  // __INJECTED_FAULT__ type=bridging nets=(N833,N752)
  assign N833 = N752;
  // __INJECTED_FAULT__ type=bridging nets=(N295,N552)
  assign N295 = N552;
  // __INJECTED_FAULT__ type=bridging nets=(N812,N255)
  assign N812 = N255;
  // __INJECTED_FAULT__ type=bridging nets=(N293,N500)
  assign N293 = N500;
  // __INJECTED_FAULT__ type=bridging nets=(N513,N540)
  assign N513 = N540;
  // __INJECTED_FAULT__ type=bridging nets=(N319,N662)
  assign N319 = N662;
  // __INJECTED_FAULT__ type=bridging nets=(N328,N527)
  assign N328 = N527;
  // __INJECTED_FAULT__ type=bridging nets=(N261,N425)
  assign N261 = N425;
  // __INJECTED_FAULT__ type=bridging nets=(N391,N589)
  assign N391 = N589;
  // __INJECTED_FAULT__ type=bridging nets=(N260,N670)
  assign N260 = N670;
  // __INJECTED_FAULT__ type=bridging nets=(N423,N631)
  assign N423 = N631;
  // __INJECTED_FAULT__ type=bridging nets=(N503,N836)
  assign N503 = N836;
  // __INJECTED_FAULT__ type=bridging nets=(N405,N727)
  assign N405 = N727;
endmodule
