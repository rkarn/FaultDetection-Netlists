...
module dec(\count[0] , \count[1] , \count[2] , \count[3] , \count[4] ,
  ...
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[73] value=1'b0
  assign \selectp2[73] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[98] value=1'b1
  assign \selectp2[98] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=n265 value=1'b1
  assign n265 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[49] value=1'b0
  assign \selectp2[49] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp1[7] value=1'b1
  assign \selectp1[7] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[90] value=1'b1
  assign \selectp2[90] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp1[66] value=1'b1
  assign \selectp1[66] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\count[5] value=1'b0
  assign \count[5] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp1[27] value=1'b1
  assign \selectp1[27] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp1[35] value=1'b0
  assign \selectp1[35] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[37] value=1'b0
  assign \selectp2[37] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[25] value=1'b1
  assign \selectp2[25] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[69] value=1'b1
  assign \selectp2[69] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp1[76] value=1'b0
  assign \selectp1[76] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[86] value=1'b1
  assign \selectp2[86] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp1[23] value=1'b0
  assign \selectp1[23] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[65] value=1'b0
  assign \selectp2[65] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp1[10] value=1'b1
  assign \selectp1[10] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp1[69] value=1'b1
  assign \selectp1[69] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=n327 value=1'b0
  assign n327 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp1[21] value=1'b0
  assign \selectp1[21] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=n267 value=1'b0
  assign n267 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[15] value=1'b1
  assign \selectp2[15] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[78] value=1'b0
  assign \selectp2[78] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=n293 value=1'b1
  assign n293 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[19] value=1'b1
  assign \selectp2[19] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[24] value=1'b0
  assign \selectp2[24] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[40] value=1'b0
  assign \selectp2[40] = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=\count[4] value=1'b1
  assign \count[4] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=\selectp2[7] value=1'b1
  assign \selectp2[7] = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=n272 value=1'b1
  assign n272 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=n_3 value=1'b0
  assign n_3 = 1'b0;
endmodule
