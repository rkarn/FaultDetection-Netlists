...
module c432(N1, N4, N8, N11, N14, N17, N21, N24, N27, N30, N34, N37,
  ...
  assign N425 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N115 value=1'b0
  assign N115 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N376 value=1'b1
  assign N376 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N99 value=1'b0
  assign N99 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=n_44 value=1'b0
  assign n_44 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N147 value=1'b0
  assign N147 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N279 value=1'b1
  assign N279 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=n_53 value=1'b1
  assign n_53 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N411 value=1'b0
  assign N411 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N431 value=1'b0
  assign N431 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N82 value=1'b1
  assign N82 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N139 value=1'b0
  assign N139 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N304 value=1'b1
  assign N304 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N255 value=1'b0
  assign N255 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=n_54 value=1'b0
  assign n_54 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N197 value=1'b1
  assign N197 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=n_58 value=1'b1
  assign n_58 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N335 value=1'b1
  assign N335 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N352 value=1'b0
  assign N352 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N407 value=1'b0
  assign N407 = 1'b0;
endmodule
