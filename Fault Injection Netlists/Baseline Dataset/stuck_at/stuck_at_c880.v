...
module c880(N1, N8, N13, N17, N26, N29, N36, N42, N51, N55, N59, N68,
  ...
  not g14 (n_96, N268);
  // __INJECTED_FAULT__ type=stuck_at net=N116 value=1'b1
  assign N116 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N808 value=1'b0
  assign N808 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N503 value=1'b0
  assign N503 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N522 value=1'b1
  assign N522 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N767 value=1'b1
  assign N767 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N849 value=1'b1
  assign N849 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N541 value=1'b0
  assign N541 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N508 value=1'b1
  assign N508 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N516 value=1'b0
  assign N516 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N509 value=1'b0
  assign N509 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N36 value=1'b0
  assign N36 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N400 value=1'b1
  assign N400 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N488 value=1'b1
  assign N488 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N498 value=1'b1
  assign N498 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N415 value=1'b0
  assign N415 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N561 value=1'b1
  assign N561 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N732 value=1'b1
  assign N732 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N183 value=1'b1
  assign N183 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N322 value=1'b1
  assign N322 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N861 value=1'b0
  assign N861 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N557 value=1'b0
  assign N557 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=n_93 value=1'b0
  assign n_93 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N533 value=1'b0
  assign N533 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N553 value=1'b1
  assign N553 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N405 value=1'b1
  assign N405 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N878 value=1'b1
  assign N878 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N540 value=1'b0
  assign N540 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=n_87 value=1'b1
  assign n_87 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N447 value=1'b1
  assign N447 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N751 value=1'b0
  assign N751 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N759 value=1'b1
  assign N759 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N449 value=1'b0
  assign N449 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N316 value=1'b0
  assign N316 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N413 value=1'b0
  assign N413 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N600 value=1'b1
  assign N600 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N677 value=1'b1
  assign N677 = 1'b1;
  // __INJECTED_FAULT__ type=stuck_at net=N476 value=1'b0
  assign N476 = 1'b0;
  // __INJECTED_FAULT__ type=stuck_at net=N138 value=1'b1
  assign N138 = 1'b1;
endmodule
