...
module c2670(N1, N2, N3, N4, N5, N6, N7, N8, N11, N14, N15, N16, N19,
  ...
  // __INJECTED_FAULT__ type=glitch net=N177_I delays=(20,30)
  initial begin
    #20 N177_I = ~N177_I;
    #30 N177_I = ~N177_I;
  end
  // __INJECTED_FAULT__ type=glitch net=N1200 delays=(17,24)
  initial begin
    #17 N1200 = ~N1200;
    #24 N1200 = ~N1200;
  end
  // __INJECTED_FAULT__ type=glitch net=N62 delays=(4,11)
  initial begin
    #4 N62 = ~N62;
    #11 N62 = ~N62;
  end
  // __INJECTED_FAULT__ type=glitch net=N2012 delays=(5,8)
  initial begin
    #5 N2012 = ~N2012;
    #8 N2012 = ~N2012;
  end
  // __INJECTED_FAULT__ type=glitch net=N1169 delays=(19,29)
  initial begin
    #19 N1169 = ~N1169;
    #29 N1169 = ~N1169;
  end
  // __INJECTED_FAULT__ type=glitch net=N1427 delays=(19,21)
  initial begin
    #19 N1427 = ~N1427;
    #21 N1427 = ~N1427;
  end
  // __INJECTED_FAULT__ type=glitch net=n_396 delays=(4,14)
  initial begin
    #4 n_396 = ~n_396;
    #14 n_396 = ~n_396;
  end
  // __INJECTED_FAULT__ type=glitch net=N217_I delays=(4,9)
  initial begin
    #4 N217_I = ~N217_I;
    #9 N217_I = ~N217_I;
  end
  // __INJECTED_FAULT__ type=glitch net=N3076 delays=(18,24)
  initial begin
    #18 N3076 = ~N3076;
    #24 N3076 = ~N3076;
  end
  // __INJECTED_FAULT__ type=glitch net=N2387 delays=(14,19)
  initial begin
    #14 N2387 = ~N2387;
    #19 N2387 = ~N2387;
  end
  // __INJECTED_FAULT__ type=glitch net=N1651 delays=(13,21)
  initial begin
    #13 N1651 = ~N1651;
    #21 N1651 = ~N1651;
  end
  // __INJECTED_FAULT__ type=glitch net=N82 delays=(19,29)
  initial begin
    #19 N82 = ~N82;
    #29 N82 = ~N82;
  end
  // __INJECTED_FAULT__ type=glitch net=N349 delays=(16,17)
  initial begin
    #16 N349 = ~N349;
    #17 N349 = ~N349;
  end
  // __INJECTED_FAULT__ type=glitch net=N2534 delays=(6,11)
  initial begin
    #6 N2534 = ~N2534;
    #11 N2534 = ~N2534;
  end
  // __INJECTED_FAULT__ type=glitch net=N2322 delays=(13,16)
  initial begin
    #13 N2322 = ~N2322;
    #16 N2322 = ~N2322;
  end
  // __INJECTED_FAULT__ type=glitch net=N2219 delays=(20,30)
  initial begin
    #20 N2219 = ~N2219;
    #30 N2219 = ~N2219;
  end
  // __INJECTED_FAULT__ type=glitch net=N126 delays=(13,14)
  initial begin
    #13 N126 = ~N126;
    #14 N126 = ~N126;
  end
  // __INJECTED_FAULT__ type=glitch net=N112 delays=(13,19)
  initial begin
    #13 N112 = ~N112;
    #19 N112 = ~N112;
  end
  // __INJECTED_FAULT__ type=glitch net=N2236 delays=(8,9)
  initial begin
    #8 N2236 = ~N2236;
    #9 N2236 = ~N2236;
  end
  // __INJECTED_FAULT__ type=glitch net=N198_O delays=(16,21)
  initial begin
    #16 N198_O = ~N198_O;
    #21 N198_O = ~N198_O;
  end
  // __INJECTED_FAULT__ type=glitch net=N2938 delays=(12,13)
  initial begin
    #12 N2938 = ~N2938;
    #13 N2938 = ~N2938;
  end
  // __INJECTED_FAULT__ type=glitch net=N1552 delays=(11,16)
  initial begin
    #11 N1552 = ~N1552;
    #16 N1552 = ~N1552;
  end
  // __INJECTED_FAULT__ type=glitch net=N1032 delays=(10,15)
  initial begin
    #10 N1032 = ~N1032;
    #15 N1032 = ~N1032;
  end
  // __INJECTED_FAULT__ type=glitch net=N3838 delays=(16,18)
  initial begin
    #16 N3838 = ~N3838;
    #18 N3838 = ~N3838;
  end
  // __INJECTED_FAULT__ type=glitch net=N2609 delays=(8,11)
  initial begin
    #8 N2609 = ~N2609;
    #11 N2609 = ~N2609;
  end
  // __INJECTED_FAULT__ type=glitch net=N1831 delays=(10,18)
  initial begin
    #10 N1831 = ~N1831;
    #18 N1831 = ~N1831;
  end
  // __INJECTED_FAULT__ type=glitch net=N218_I delays=(11,16)
  initial begin
    #11 N218_I = ~N218_I;
    #16 N218_I = ~N218_I;
  end
  // __INJECTED_FAULT__ type=glitch net=N1578 delays=(14,24)
  initial begin
    #14 N1578 = ~N1578;
    #24 N1578 = ~N1578;
  end
  // __INJECTED_FAULT__ type=glitch net=N81 delays=(3,7)
  initial begin
    #3 N81 = ~N81;
    #7 N81 = ~N81;
  end
  // __INJECTED_FAULT__ type=glitch net=N3137 delays=(15,19)
  initial begin
    #15 N3137 = ~N3137;
    #19 N3137 = ~N3137;
  end
  // __INJECTED_FAULT__ type=glitch net=N659 delays=(14,22)
  initial begin
    #14 N659 = ~N659;
    #22 N659 = ~N659;
  end
  // __INJECTED_FAULT__ type=glitch net=N2992 delays=(17,23)
  initial begin
    #17 N2992 = ~N2992;
    #23 N2992 = ~N2992;
  end
  // __INJECTED_FAULT__ type=glitch net=N1533 delays=(2,11)
  initial begin
    #2 N1533 = ~N1533;
    #11 N1533 = ~N1533;
  end
  // __INJECTED_FAULT__ type=glitch net=N1065 delays=(6,8)
  initial begin
    #6 N1065 = ~N1065;
    #8 N1065 = ~N1065;
  end
  // __INJECTED_FAULT__ type=glitch net=N1546 delays=(10,19)
  initial begin
    #10 N1546 = ~N1546;
    #19 N1546 = ~N1546;
  end
  // __INJECTED_FAULT__ type=glitch net=N2312 delays=(13,16)
  initial begin
    #13 N2312 = ~N2312;
    #16 N2312 = ~N2312;
  end
  // __INJECTED_FAULT__ type=glitch net=N3286 delays=(17,27)
  initial begin
    #17 N3286 = ~N3286;
    #27 N3286 = ~N3286;
  end
  // __INJECTED_FAULT__ type=glitch net=N3693 delays=(1,4)
  initial begin
    #1 N3693 = ~N3693;
    #4 N3693 = ~N3693;
  end
  // __INJECTED_FAULT__ type=glitch net=N1456 delays=(7,11)
  initial begin
    #7 N1456 = ~N1456;
    #11 N1456 = ~N1456;
  end
  // __INJECTED_FAULT__ type=glitch net=N1776 delays=(2,6)
  initial begin
    #2 N1776 = ~N1776;
    #6 N1776 = ~N1776;
  end
  // __INJECTED_FAULT__ type=glitch net=N3401 delays=(2,10)
  initial begin
    #2 N3401 = ~N3401;
    #10 N3401 = ~N3401;
  end
  // __INJECTED_FAULT__ type=glitch net=N487 delays=(2,8)
  initial begin
    #2 N487 = ~N487;
    #8 N487 = ~N487;
  end
  // __INJECTED_FAULT__ type=glitch net=N1457 delays=(7,12)
  initial begin
    #7 N1457 = ~N1457;
    #12 N1457 = ~N1457;
  end
  // __INJECTED_FAULT__ type=glitch net=N152_O delays=(12,20)
  initial begin
    #12 N152_O = ~N152_O;
    #20 N152_O = ~N152_O;
  end
  // __INJECTED_FAULT__ type=glitch net=N103 delays=(17,24)
  initial begin
    #17 N103 = ~N103;
    #24 N103 = ~N103;
  end
  // __INJECTED_FAULT__ type=glitch net=N705 delays=(4,5)
  initial begin
    #4 N705 = ~N705;
    #5 N705 = ~N705;
  end
  // __INJECTED_FAULT__ type=glitch net=N3492 delays=(8,14)
  initial begin
    #8 N3492 = ~N3492;
    #14 N3492 = ~N3492;
  end
  // __INJECTED_FAULT__ type=glitch net=N3195 delays=(16,26)
  initial begin
    #16 N3195 = ~N3195;
    #26 N3195 = ~N3195;
  end
  // __INJECTED_FAULT__ type=glitch net=N2340 delays=(15,18)
  initial begin
    #15 N2340 = ~N2340;
    #18 N2340 = ~N2340;
  end
  // __INJECTED_FAULT__ type=glitch net=N50 delays=(16,26)
  initial begin
    #16 N50 = ~N50;
    #26 N50 = ~N50;
  end
  // __INJECTED_FAULT__ type=glitch net=N1484 delays=(18,24)
  initial begin
    #18 N1484 = ~N1484;
    #24 N1484 = ~N1484;
  end
  // __INJECTED_FAULT__ type=glitch net=N1770 delays=(12,15)
  initial begin
    #12 N1770 = ~N1770;
    #15 N1770 = ~N1770;
  end
  // __INJECTED_FAULT__ type=glitch net=N3490 delays=(9,11)
  initial begin
    #9 N3490 = ~N3490;
    #11 N3490 = ~N3490;
  end
  // __INJECTED_FAULT__ type=glitch net=N1506 delays=(10,11)
  initial begin
    #10 N1506 = ~N1506;
    #11 N1506 = ~N1506;
  end
  // __INJECTED_FAULT__ type=glitch net=N2894 delays=(13,14)
  initial begin
    #13 N2894 = ~N2894;
    #14 N2894 = ~N2894;
  end
  // __INJECTED_FAULT__ type=glitch net=N1773 delays=(6,16)
  initial begin
    #6 N1773 = ~N1773;
    #16 N1773 = ~N1773;
  end
  // __INJECTED_FAULT__ type=glitch net=N2302 delays=(7,11)
  initial begin
    #7 N2302 = ~N2302;
    #11 N2302 = ~N2302;
  end
  // __INJECTED_FAULT__ type=glitch net=N2031 delays=(8,12)
  initial begin
    #8 N2031 = ~N2031;
    #12 N2031 = ~N2031;
  end
  // __INJECTED_FAULT__ type=glitch net=N337 delays=(9,16)
  initial begin
    #9 N337 = ~N337;
    #16 N337 = ~N337;
  end
  // __INJECTED_FAULT__ type=glitch net=N253 delays=(17,18)
  initial begin
    #17 N253 = ~N253;
    #18 N253 = ~N253;
  end
  // __INJECTED_FAULT__ type=glitch net=N2610 delays=(1,9)
  initial begin
    #1 N2610 = ~N2610;
    #9 N2610 = ~N2610;
  end
  // __INJECTED_FAULT__ type=glitch net=N1276 delays=(5,8)
  initial begin
    #5 N1276 = ~N1276;
    #8 N1276 = ~N1276;
  end
  // __INJECTED_FAULT__ type=glitch net=N163_I delays=(20,21)
  initial begin
    #20 N163_I = ~N163_I;
    #21 N163_I = ~N163_I;
  end
  // __INJECTED_FAULT__ type=glitch net=N157_I delays=(8,13)
  initial begin
    #8 N157_I = ~N157_I;
    #13 N157_I = ~N157_I;
  end
  // __INJECTED_FAULT__ type=glitch net=N202_I delays=(20,25)
  initial begin
    #20 N202_I = ~N202_I;
    #25 N202_I = ~N202_I;
  end
  // __INJECTED_FAULT__ type=glitch net=n_379 delays=(9,16)
  initial begin
    #9 n_379 = ~n_379;
    #16 n_379 = ~n_379;
  end
  // __INJECTED_FAULT__ type=glitch net=N183_I delays=(13,19)
  initial begin
    #13 N183_I = ~N183_I;
    #19 N183_I = ~N183_I;
  end
  // __INJECTED_FAULT__ type=glitch net=N269 delays=(15,20)
  initial begin
    #15 N269 = ~N269;
    #20 N269 = ~N269;
  end
  // __INJECTED_FAULT__ type=glitch net=N60 delays=(7,15)
  initial begin
    #7 N60 = ~N60;
    #15 N60 = ~N60;
  end
  // __INJECTED_FAULT__ type=glitch net=N1097 delays=(10,19)
  initial begin
    #10 N1097 = ~N1097;
    #19 N1097 = ~N1097;
  end
  // __INJECTED_FAULT__ type=glitch net=N3754 delays=(20,27)
  initial begin
    #20 N3754 = ~N3754;
    #27 N3754 = ~N3754;
  end
  // __INJECTED_FAULT__ type=glitch net=N2308 delays=(19,21)
  initial begin
    #19 N2308 = ~N2308;
    #21 N2308 = ~N2308;
  end
  // __INJECTED_FAULT__ type=glitch net=N1129 delays=(1,10)
  initial begin
    #1 N1129 = ~N1129;
    #10 N1129 = ~N1129;
  end
  // __INJECTED_FAULT__ type=glitch net=N192_I delays=(12,21)
  initial begin
    #12 N192_I = ~N192_I;
    #21 N192_I = ~N192_I;
  end
  // __INJECTED_FAULT__ type=glitch net=N3036 delays=(20,30)
  initial begin
    #20 N3036 = ~N3036;
    #30 N3036 = ~N3036;
  end
  // __INJECTED_FAULT__ type=glitch net=N2046 delays=(10,15)
  initial begin
    #10 N2046 = ~N2046;
    #15 N2046 = ~N2046;
  end
  // __INJECTED_FAULT__ type=glitch net=N340 delays=(4,12)
  initial begin
    #4 N340 = ~N340;
    #12 N340 = ~N340;
  end
  // __INJECTED_FAULT__ type=glitch net=N3060 delays=(3,9)
  initial begin
    #3 N3060 = ~N3060;
    #9 N3060 = ~N3060;
  end
  // __INJECTED_FAULT__ type=glitch net=N1894 delays=(9,15)
  initial begin
    #9 N1894 = ~N1894;
    #15 N1894 = ~N1894;
  end
  // __INJECTED_FAULT__ type=glitch net=N1821 delays=(9,14)
  initial begin
    #9 N1821 = ~N1821;
    #14 N1821 = ~N1821;
  end
  // __INJECTED_FAULT__ type=glitch net=N173_O delays=(10,14)
  initial begin
    #10 N173_O = ~N173_O;
    #14 N173_O = ~N173_O;
  end
  // __INJECTED_FAULT__ type=glitch net=N3555 delays=(5,14)
  initial begin
    #5 N3555 = ~N3555;
    #14 N3555 = ~N3555;
  end
  // __INJECTED_FAULT__ type=glitch net=N2410 delays=(8,9)
  initial begin
    #8 N2410 = ~N2410;
    #9 N2410 = ~N2410;
  end
  // __INJECTED_FAULT__ type=glitch net=N3592 delays=(20,27)
  initial begin
    #20 N3592 = ~N3592;
    #27 N3592 = ~N3592;
  end
  // __INJECTED_FAULT__ type=glitch net=N2901 delays=(11,14)
  initial begin
    #11 N2901 = ~N2901;
    #14 N2901 = ~N2901;
  end
  // __INJECTED_FAULT__ type=glitch net=N89 delays=(1,9)
  initial begin
    #1 N89 = ~N89;
    #9 N89 = ~N89;
  end
  // __INJECTED_FAULT__ type=glitch net=N114 delays=(10,15)
  initial begin
    #10 N114 = ~N114;
    #15 N114 = ~N114;
  end
  // __INJECTED_FAULT__ type=glitch net=N663 delays=(14,21)
  initial begin
    #14 N663 = ~N663;
    #21 N663 = ~N663;
  end
  // __INJECTED_FAULT__ type=glitch net=N1585 delays=(13,14)
  initial begin
    #13 N1585 = ~N1585;
    #14 N1585 = ~N1585;
  end
  // __INJECTED_FAULT__ type=glitch net=N715 delays=(19,29)
  initial begin
    #19 N715 = ~N715;
    #29 N715 = ~N715;
  end
  // __INJECTED_FAULT__ type=glitch net=N1571 delays=(7,13)
  initial begin
    #7 N1571 = ~N1571;
    #13 N1571 = ~N1571;
  end
  // __INJECTED_FAULT__ type=glitch net=N179_O delays=(8,17)
  initial begin
    #8 N179_O = ~N179_O;
    #17 N179_O = ~N179_O;
  end
  // __INJECTED_FAULT__ type=glitch net=N3215 delays=(16,22)
  initial begin
    #16 N3215 = ~N3215;
    #22 N3215 = ~N3215;
  end
  // __INJECTED_FAULT__ type=glitch net=N2891 delays=(17,22)
  initial begin
    #17 N2891 = ~N2891;
    #22 N2891 = ~N2891;
  end
  // __INJECTED_FAULT__ type=glitch net=N1530 delays=(6,15)
  initial begin
    #6 N1530 = ~N1530;
    #15 N1530 = ~N1530;
  end
  // __INJECTED_FAULT__ type=glitch net=N1398 delays=(6,11)
  initial begin
    #6 N1398 = ~N1398;
    #11 N1398 = ~N1398;
  end
  // __INJECTED_FAULT__ type=glitch net=N3301 delays=(4,12)
  initial begin
    #4 N3301 = ~N3301;
    #12 N3301 = ~N3301;
  end
  // __INJECTED_FAULT__ type=glitch net=N19 delays=(5,10)
  initial begin
    #5 N19 = ~N19;
    #10 N19 = ~N19;
  end
  // __INJECTED_FAULT__ type=glitch net=N2792 delays=(18,21)
  initial begin
    #18 N2792 = ~N2792;
    #21 N2792 = ~N2792;
  end
  // __INJECTED_FAULT__ type=glitch net=N2326 delays=(11,13)
  initial begin
    #11 N2326 = ~N2326;
    #13 N2326 = ~N2326;
  end
