...
module c880(N1, N8, N13, N17, N26, N29, N36, N42, N51, N55, N59, N68,
  ...
  not g14 (n_96, N268);
  // __INJECTED_FAULT__ type=glitch net=N746 delays=(20,23)
  initial begin
    #20 N746 = ~N746;
    #23 N746 = ~N746;
  end
  // __INJECTED_FAULT__ type=glitch net=N609 delays=(18,24)
  initial begin
    #18 N609 = ~N609;
    #24 N609 = ~N609;
  end
  // __INJECTED_FAULT__ type=glitch net=N734 delays=(11,16)
  initial begin
    #11 N734 = ~N734;
    #16 N734 = ~N734;
  end
  // __INJECTED_FAULT__ type=glitch net=N550 delays=(9,15)
  initial begin
    #9 N550 = ~N550;
    #15 N550 = ~N550;
  end
  // __INJECTED_FAULT__ type=glitch net=N349 delays=(4,13)
  initial begin
    #4 N349 = ~N349;
    #13 N349 = ~N349;
  end
  // __INJECTED_FAULT__ type=glitch net=N781 delays=(19,25)
  initial begin
    #19 N781 = ~N781;
    #25 N781 = ~N781;
  end
  // __INJECTED_FAULT__ type=glitch net=N826 delays=(5,6)
  initial begin
    #5 N826 = ~N826;
    #6 N826 = ~N826;
  end
  // __INJECTED_FAULT__ type=glitch net=N600 delays=(5,14)
  initial begin
    #5 N600 = ~N600;
    #14 N600 = ~N600;
  end
  // __INJECTED_FAULT__ type=glitch net=N831 delays=(10,16)
  initial begin
    #10 N831 = ~N831;
    #16 N831 = ~N831;
  end
  // __INJECTED_FAULT__ type=glitch net=N389 delays=(16,23)
  initial begin
    #16 N389 = ~N389;
    #23 N389 = ~N389;
  end
  // __INJECTED_FAULT__ type=glitch net=N510 delays=(11,14)
  initial begin
    #11 N510 = ~N510;
    #14 N510 = ~N510;
  end
  // __INJECTED_FAULT__ type=glitch net=N659 delays=(4,8)
  initial begin
    #4 N659 = ~N659;
    #8 N659 = ~N659;
  end
  // __INJECTED_FAULT__ type=glitch net=n_89 delays=(5,14)
  initial begin
    #5 n_89 = ~n_89;
    #14 n_89 = ~n_89;
  end
  // __INJECTED_FAULT__ type=glitch net=N742 delays=(8,12)
  initial begin
    #8 N742 = ~N742;
    #12 N742 = ~N742;
  end
  // __INJECTED_FAULT__ type=glitch net=N51 delays=(18,28)
  initial begin
    #18 N51 = ~N51;
    #28 N51 = ~N51;
  end
  // __INJECTED_FAULT__ type=glitch net=N878 delays=(17,26)
  initial begin
    #17 N878 = ~N878;
    #26 N878 = ~N878;
  end
  // __INJECTED_FAULT__ type=glitch net=N121 delays=(18,20)
  initial begin
    #18 N121 = ~N121;
    #20 N121 = ~N121;
  end
  // __INJECTED_FAULT__ type=glitch net=N450 delays=(14,22)
  initial begin
    #14 N450 = ~N450;
    #22 N450 = ~N450;
  end
  // __INJECTED_FAULT__ type=glitch net=N442 delays=(3,5)
  initial begin
    #3 N442 = ~N442;
    #5 N442 = ~N442;
  end
  // __INJECTED_FAULT__ type=glitch net=N587 delays=(5,6)
  initial begin
    #5 N587 = ~N587;
    #6 N587 = ~N587;
  end
  // __INJECTED_FAULT__ type=glitch net=N830 delays=(16,22)
  initial begin
    #16 N830 = ~N830;
    #22 N830 = ~N830;
  end
  // __INJECTED_FAULT__ type=glitch net=N423 delays=(10,16)
  initial begin
    #10 N423 = ~N423;
    #16 N423 = ~N423;
  end
  // __INJECTED_FAULT__ type=glitch net=N501 delays=(5,13)
  initial begin
    #5 N501 = ~N501;
    #13 N501 = ~N501;
  end
  // __INJECTED_FAULT__ type=glitch net=N111 delays=(20,29)
  initial begin
    #20 N111 = ~N111;
    #29 N111 = ~N111;
  end
  // __INJECTED_FAULT__ type=glitch net=N366 delays=(11,14)
  initial begin
    #11 N366 = ~N366;
    #14 N366 = ~N366;
  end
  // __INJECTED_FAULT__ type=glitch net=N503 delays=(10,11)
  initial begin
    #10 N503 = ~N503;
    #11 N503 = ~N503;
  end
  // __INJECTED_FAULT__ type=glitch net=N537 delays=(4,8)
  initial begin
    #4 N537 = ~N537;
    #8 N537 = ~N537;
  end
  // __INJECTED_FAULT__ type=glitch net=N787 delays=(5,8)
  initial begin
    #5 N787 = ~N787;
    #8 N787 = ~N787;
  end
  // __INJECTED_FAULT__ type=glitch net=N96 delays=(8,13)
  initial begin
    #8 N96 = ~N96;
    #13 N96 = ~N96;
  end
  // __INJECTED_FAULT__ type=glitch net=N406 delays=(5,9)
  initial begin
    #5 N406 = ~N406;
    #9 N406 = ~N406;
  end
  // __INJECTED_FAULT__ type=glitch net=N407 delays=(5,7)
  initial begin
    #5 N407 = ~N407;
    #7 N407 = ~N407;
  end
  // __INJECTED_FAULT__ type=glitch net=N686 delays=(14,16)
  initial begin
    #14 N686 = ~N686;
    #16 N686 = ~N686;
  end
  // __INJECTED_FAULT__ type=glitch net=N789 delays=(3,4)
  initial begin
    #3 N789 = ~N789;
    #4 N789 = ~N789;
  end
  // __INJECTED_FAULT__ type=glitch net=N156 delays=(16,23)
  initial begin
    #16 N156 = ~N156;
    #23 N156 = ~N156;
  end
  // __INJECTED_FAULT__ type=glitch net=N662 delays=(2,6)
  initial begin
    #2 N662 = ~N662;
    #6 N662 = ~N662;
  end
  // __INJECTED_FAULT__ type=glitch net=N303 delays=(4,5)
  initial begin
    #4 N303 = ~N303;
    #5 N303 = ~N303;
  end
  // __INJECTED_FAULT__ type=glitch net=N294 delays=(17,27)
  initial begin
    #17 N294 = ~N294;
    #27 N294 = ~N294;
  end
  // __INJECTED_FAULT__ type=glitch net=N207 delays=(2,10)
  initial begin
    #2 N207 = ~N207;
    #10 N207 = ~N207;
  end
