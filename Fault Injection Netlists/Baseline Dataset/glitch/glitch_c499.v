...
module c499(N1, N5, N9, N13, N17, N21, N25, N29, N33, N37, N41, N45,
  ...
  // __INJECTED_FAULT__ type=glitch net=N567 delays=(17,23)
  initial begin
    #17 N567 = ~N567;
    #23 N567 = ~N567;
  end
  // __INJECTED_FAULT__ type=glitch net=N257 delays=(13,16)
  initial begin
    #13 N257 = ~N257;
    #16 N257 = ~N257;
  end
  // __INJECTED_FAULT__ type=glitch net=N319 delays=(15,17)
  initial begin
    #15 N319 = ~N319;
    #17 N319 = ~N319;
  end
  // __INJECTED_FAULT__ type=glitch net=N380 delays=(17,25)
  initial begin
    #17 N380 = ~N380;
    #25 N380 = ~N380;
  end
  // __INJECTED_FAULT__ type=glitch net=N753 delays=(11,12)
  initial begin
    #11 N753 = ~N753;
    #12 N753 = ~N753;
  end
  // __INJECTED_FAULT__ type=glitch net=N318 delays=(1,5)
  initial begin
    #1 N318 = ~N318;
    #5 N318 = ~N318;
  end
  // __INJECTED_FAULT__ type=glitch net=N729 delays=(13,23)
  initial begin
    #13 N729 = ~N729;
    #23 N729 = ~N729;
  end
  // __INJECTED_FAULT__ type=glitch net=N708 delays=(4,10)
  initial begin
    #4 N708 = ~N708;
    #10 N708 = ~N708;
  end
  // __INJECTED_FAULT__ type=glitch net=N339 delays=(12,22)
  initial begin
    #12 N339 = ~N339;
    #22 N339 = ~N339;
  end
  // __INJECTED_FAULT__ type=glitch net=N754 delays=(9,12)
  initial begin
    #9 N754 = ~N754;
    #12 N754 = ~N754;
  end
  // __INJECTED_FAULT__ type=glitch net=N278 delays=(18,23)
  initial begin
    #18 N278 = ~N278;
    #23 N278 = ~N278;
  end
  // __INJECTED_FAULT__ type=glitch net=N739 delays=(8,13)
  initial begin
    #8 N739 = ~N739;
    #13 N739 = ~N739;
  end
  // __INJECTED_FAULT__ type=glitch net=N705 delays=(16,26)
  initial begin
    #16 N705 = ~N705;
    #26 N705 = ~N705;
  end
  // __INJECTED_FAULT__ type=glitch net=N129 delays=(11,17)
  initial begin
    #11 N129 = ~N129;
    #17 N129 = ~N129;
  end
  // __INJECTED_FAULT__ type=glitch net=N53 delays=(6,14)
  initial begin
    #6 N53 = ~N53;
    #14 N53 = ~N53;
  end
  // __INJECTED_FAULT__ type=glitch net=N343 delays=(14,18)
  initial begin
    #14 N343 = ~N343;
    #18 N343 = ~N343;
  end
  // __INJECTED_FAULT__ type=glitch net=N717 delays=(14,20)
  initial begin
    #14 N717 = ~N717;
    #20 N717 = ~N717;
  end
  // __INJECTED_FAULT__ type=glitch net=N285 delays=(12,19)
  initial begin
    #12 N285 = ~N285;
    #19 N285 = ~N285;
  end
  // __INJECTED_FAULT__ type=glitch net=N315 delays=(9,17)
  initial begin
    #9 N315 = ~N315;
    #17 N315 = ~N315;
  end
  // __INJECTED_FAULT__ type=glitch net=N347 delays=(6,16)
  initial begin
    #6 N347 = ~N347;
    #16 N347 = ~N347;
  end
  // __INJECTED_FAULT__ type=glitch net=N33 delays=(5,15)
  initial begin
    #5 N33 = ~N33;
    #15 N33 = ~N33;
  end
