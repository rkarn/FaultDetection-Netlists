...
module max(\in0[0] , \in0[1] , \in0[2] , \in0[3] , \in0[4] , \in0[5] ,
  ...
  // __INJECTED_FAULT__ type=glitch net=n1522 delays=(9,18)
  initial begin
    #9 n1522 = ~n1522;
    #18 n1522 = ~n1522;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2043 delays=(6,12)
  initial begin
    #6 n_2043 = ~n_2043;
    #12 n_2043 = ~n_2043;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2388 delays=(7,9)
  initial begin
    #7 n_2388 = ~n_2388;
    #9 n_2388 = ~n_2388;
  end
  // __INJECTED_FAULT__ type=glitch net=n1402 delays=(3,4)
  initial begin
    #3 n1402 = ~n1402;
    #4 n1402 = ~n1402;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1961 delays=(14,15)
  initial begin
    #14 n_1961 = ~n_1961;
    #15 n_1961 = ~n_1961;
  end
  // __INJECTED_FAULT__ type=glitch net=n_614 delays=(19,22)
  initial begin
    #19 n_614 = ~n_614;
    #22 n_614 = ~n_614;
  end
  // __INJECTED_FAULT__ type=glitch net=n3437 delays=(1,11)
  initial begin
    #1 n3437 = ~n3437;
    #11 n3437 = ~n3437;
  end
  // __INJECTED_FAULT__ type=glitch net=n2473 delays=(18,20)
  initial begin
    #18 n2473 = ~n2473;
    #20 n2473 = ~n2473;
  end
  // __INJECTED_FAULT__ type=glitch net=n_3003 delays=(19,26)
  initial begin
    #19 n_3003 = ~n_3003;
    #26 n_3003 = ~n_3003;
  end
  // __INJECTED_FAULT__ type=glitch net=n_3304 delays=(1,4)
  initial begin
    #1 n_3304 = ~n_3304;
    #4 n_3304 = ~n_3304;
  end
  // __INJECTED_FAULT__ type=glitch net=n_640 delays=(15,21)
  initial begin
    #15 n_640 = ~n_640;
    #21 n_640 = ~n_640;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2736 delays=(6,10)
  initial begin
    #6 n_2736 = ~n_2736;
    #10 n_2736 = ~n_2736;
  end
  // __INJECTED_FAULT__ type=glitch net=n2459 delays=(8,13)
  initial begin
    #8 n2459 = ~n2459;
    #13 n2459 = ~n2459;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2597 delays=(7,16)
  initial begin
    #7 n_2597 = ~n_2597;
    #16 n_2597 = ~n_2597;
  end
  // __INJECTED_FAULT__ type=glitch net=n813 delays=(8,15)
  initial begin
    #8 n813 = ~n813;
    #15 n813 = ~n813;
  end
  // __INJECTED_FAULT__ type=glitch net=n718 delays=(9,10)
  initial begin
    #9 n718 = ~n718;
    #10 n718 = ~n718;
  end
  // __INJECTED_FAULT__ type=glitch net=n851 delays=(9,11)
  initial begin
    #9 n851 = ~n851;
    #11 n851 = ~n851;
  end
  // __INJECTED_FAULT__ type=glitch net=n735 delays=(5,6)
  initial begin
    #5 n735 = ~n735;
    #6 n735 = ~n735;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2903 delays=(19,21)
  initial begin
    #19 n_2903 = ~n_2903;
    #21 n_2903 = ~n_2903;
  end
  // __INJECTED_FAULT__ type=glitch net=\in1[6] delays=(4,12)
  initial begin
    #4 \in1[6] = ~\in1[6];
    #12 \in1[6] = ~\in1[6];
  end
  // __INJECTED_FAULT__ type=glitch net=n_2563 delays=(20,22)
  initial begin
    #20 n_2563 = ~n_2563;
    #22 n_2563 = ~n_2563;
  end
  // __INJECTED_FAULT__ type=glitch net=n_355 delays=(4,7)
  initial begin
    #4 n_355 = ~n_355;
    #7 n_355 = ~n_355;
  end
  // __INJECTED_FAULT__ type=glitch net=n850 delays=(10,15)
  initial begin
    #10 n850 = ~n850;
    #15 n850 = ~n850;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1418 delays=(6,8)
  initial begin
    #6 n_1418 = ~n_1418;
    #8 n_1418 = ~n_1418;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2627 delays=(3,11)
  initial begin
    #3 n_2627 = ~n_2627;
    #11 n_2627 = ~n_2627;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1977 delays=(12,16)
  initial begin
    #12 n_1977 = ~n_1977;
    #16 n_1977 = ~n_1977;
  end
  // __INJECTED_FAULT__ type=glitch net=n817 delays=(13,15)
  initial begin
    #13 n817 = ~n817;
    #15 n817 = ~n817;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2720 delays=(16,17)
  initial begin
    #16 n_2720 = ~n_2720;
    #17 n_2720 = ~n_2720;
  end
  // __INJECTED_FAULT__ type=glitch net=n_736 delays=(14,16)
  initial begin
    #14 n_736 = ~n_736;
    #16 n_736 = ~n_736;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1487 delays=(16,18)
  initial begin
    #16 n_1487 = ~n_1487;
    #18 n_1487 = ~n_1487;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2276 delays=(7,14)
  initial begin
    #7 n_2276 = ~n_2276;
    #14 n_2276 = ~n_2276;
  end
  // __INJECTED_FAULT__ type=glitch net=\in2[11] delays=(13,19)
  initial begin
    #13 \in2[11] = ~\in2[11];
    #19 \in2[11] = ~\in2[11];
  end
  // __INJECTED_FAULT__ type=glitch net=n_3201 delays=(15,18)
  initial begin
    #15 n_3201 = ~n_3201;
    #18 n_3201 = ~n_3201;
  end
  // __INJECTED_FAULT__ type=glitch net=n2513 delays=(6,11)
  initial begin
    #6 n2513 = ~n2513;
    #11 n2513 = ~n2513;
  end
  // __INJECTED_FAULT__ type=glitch net=n_450 delays=(1,4)
  initial begin
    #1 n_450 = ~n_450;
    #4 n_450 = ~n_450;
  end
  // __INJECTED_FAULT__ type=glitch net=n1874 delays=(19,29)
  initial begin
    #19 n1874 = ~n1874;
    #29 n1874 = ~n1874;
  end
  // __INJECTED_FAULT__ type=glitch net=n1964 delays=(2,4)
  initial begin
    #2 n1964 = ~n1964;
    #4 n1964 = ~n1964;
  end
  // __INJECTED_FAULT__ type=glitch net=n_886 delays=(11,17)
  initial begin
    #11 n_886 = ~n_886;
    #17 n_886 = ~n_886;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2033 delays=(16,26)
  initial begin
    #16 n_2033 = ~n_2033;
    #26 n_2033 = ~n_2033;
  end
  // __INJECTED_FAULT__ type=glitch net=n3431 delays=(20,29)
  initial begin
    #20 n3431 = ~n3431;
    #29 n3431 = ~n3431;
  end
  // __INJECTED_FAULT__ type=glitch net=n938 delays=(1,4)
  initial begin
    #1 n938 = ~n938;
    #4 n938 = ~n938;
  end
  // __INJECTED_FAULT__ type=glitch net=n1733 delays=(17,22)
  initial begin
    #17 n1733 = ~n1733;
    #22 n1733 = ~n1733;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1090 delays=(4,8)
  initial begin
    #4 n_1090 = ~n_1090;
    #8 n_1090 = ~n_1090;
  end
  // __INJECTED_FAULT__ type=glitch net=n1051 delays=(20,21)
  initial begin
    #20 n1051 = ~n1051;
    #21 n1051 = ~n1051;
  end
  // __INJECTED_FAULT__ type=glitch net=n3076 delays=(18,19)
  initial begin
    #18 n3076 = ~n3076;
    #19 n3076 = ~n3076;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1010 delays=(17,26)
  initial begin
    #17 n_1010 = ~n_1010;
    #26 n_1010 = ~n_1010;
  end
  // __INJECTED_FAULT__ type=glitch net=n_379 delays=(5,9)
  initial begin
    #5 n_379 = ~n_379;
    #9 n_379 = ~n_379;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2850 delays=(12,14)
  initial begin
    #12 n_2850 = ~n_2850;
    #14 n_2850 = ~n_2850;
  end
  // __INJECTED_FAULT__ type=glitch net=n_127 delays=(7,8)
  initial begin
    #7 n_127 = ~n_127;
    #8 n_127 = ~n_127;
  end
  // __INJECTED_FAULT__ type=glitch net=\in0[62] delays=(11,14)
  initial begin
    #11 \in0[62] = ~\in0[62];
    #14 \in0[62] = ~\in0[62];
  end
  // __INJECTED_FAULT__ type=glitch net=n3353 delays=(8,10)
  initial begin
    #8 n3353 = ~n3353;
    #10 n3353 = ~n3353;
  end
  // __INJECTED_FAULT__ type=glitch net=n1973 delays=(5,10)
  initial begin
    #5 n1973 = ~n1973;
    #10 n1973 = ~n1973;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1551 delays=(9,17)
  initial begin
    #9 n_1551 = ~n_1551;
    #17 n_1551 = ~n_1551;
  end
  // __INJECTED_FAULT__ type=glitch net=n2462 delays=(7,9)
  initial begin
    #7 n2462 = ~n2462;
    #9 n2462 = ~n2462;
  end
  // __INJECTED_FAULT__ type=glitch net=n2331 delays=(12,21)
  initial begin
    #12 n2331 = ~n2331;
    #21 n2331 = ~n2331;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2995 delays=(10,18)
  initial begin
    #10 n_2995 = ~n_2995;
    #18 n_2995 = ~n_2995;
  end
  // __INJECTED_FAULT__ type=glitch net=n2305 delays=(16,23)
  initial begin
    #16 n2305 = ~n2305;
    #23 n2305 = ~n2305;
  end
  // __INJECTED_FAULT__ type=glitch net=n2657 delays=(17,24)
  initial begin
    #17 n2657 = ~n2657;
    #24 n2657 = ~n2657;
  end
  // __INJECTED_FAULT__ type=glitch net=n_398 delays=(7,12)
  initial begin
    #7 n_398 = ~n_398;
    #12 n_398 = ~n_398;
  end
  // __INJECTED_FAULT__ type=glitch net=n_3247 delays=(6,10)
  initial begin
    #6 n_3247 = ~n_3247;
    #10 n_3247 = ~n_3247;
  end
  // __INJECTED_FAULT__ type=glitch net=n2117 delays=(9,16)
  initial begin
    #9 n2117 = ~n2117;
    #16 n2117 = ~n2117;
  end
  // __INJECTED_FAULT__ type=glitch net=\in0[34] delays=(4,14)
  initial begin
    #4 \in0[34] = ~\in0[34];
    #14 \in0[34] = ~\in0[34];
  end
  // __INJECTED_FAULT__ type=glitch net=n_397 delays=(19,24)
  initial begin
    #19 n_397 = ~n_397;
    #24 n_397 = ~n_397;
  end
  // __INJECTED_FAULT__ type=glitch net=\in0[127] delays=(6,10)
  initial begin
    #6 \in0[127] = ~\in0[127];
    #10 \in0[127] = ~\in0[127];
  end
  // __INJECTED_FAULT__ type=glitch net=\in1[87] delays=(16,23)
  initial begin
    #16 \in1[87] = ~\in1[87];
    #23 \in1[87] = ~\in1[87];
  end
  // __INJECTED_FAULT__ type=glitch net=n1326 delays=(15,22)
  initial begin
    #15 n1326 = ~n1326;
    #22 n1326 = ~n1326;
  end
  // __INJECTED_FAULT__ type=glitch net=n3350 delays=(20,25)
  initial begin
    #20 n3350 = ~n3350;
    #25 n3350 = ~n3350;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1716 delays=(11,21)
  initial begin
    #11 n_1716 = ~n_1716;
    #21 n_1716 = ~n_1716;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2429 delays=(4,14)
  initial begin
    #4 n_2429 = ~n_2429;
    #14 n_2429 = ~n_2429;
  end
  // __INJECTED_FAULT__ type=glitch net=n2750 delays=(13,20)
  initial begin
    #13 n2750 = ~n2750;
    #20 n2750 = ~n2750;
  end
  // __INJECTED_FAULT__ type=glitch net=n2923 delays=(7,17)
  initial begin
    #7 n2923 = ~n2923;
    #17 n2923 = ~n2923;
  end
  // __INJECTED_FAULT__ type=glitch net=n1466 delays=(12,18)
  initial begin
    #12 n1466 = ~n1466;
    #18 n1466 = ~n1466;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2202 delays=(3,11)
  initial begin
    #3 n_2202 = ~n_2202;
    #11 n_2202 = ~n_2202;
  end
  // __INJECTED_FAULT__ type=glitch net=n_535 delays=(6,7)
  initial begin
    #6 n_535 = ~n_535;
    #7 n_535 = ~n_535;
  end
  // __INJECTED_FAULT__ type=glitch net=n2120 delays=(17,22)
  initial begin
    #17 n2120 = ~n2120;
    #22 n2120 = ~n2120;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2067 delays=(19,26)
  initial begin
    #19 n_2067 = ~n_2067;
    #26 n_2067 = ~n_2067;
  end
  // __INJECTED_FAULT__ type=glitch net=n_62 delays=(10,20)
  initial begin
    #10 n_62 = ~n_62;
    #20 n_62 = ~n_62;
  end
  // __INJECTED_FAULT__ type=glitch net=n1697 delays=(17,23)
  initial begin
    #17 n1697 = ~n1697;
    #23 n1697 = ~n1697;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2847 delays=(13,14)
  initial begin
    #13 n_2847 = ~n_2847;
    #14 n_2847 = ~n_2847;
  end
  // __INJECTED_FAULT__ type=glitch net=n_90 delays=(4,7)
  initial begin
    #4 n_90 = ~n_90;
    #7 n_90 = ~n_90;
  end
  // __INJECTED_FAULT__ type=glitch net=\in3[38] delays=(11,18)
  initial begin
    #11 \in3[38] = ~\in3[38];
    #18 \in3[38] = ~\in3[38];
  end
  // __INJECTED_FAULT__ type=glitch net=n_2248 delays=(6,12)
  initial begin
    #6 n_2248 = ~n_2248;
    #12 n_2248 = ~n_2248;
  end
  // __INJECTED_FAULT__ type=glitch net=n_528 delays=(8,10)
  initial begin
    #8 n_528 = ~n_528;
    #10 n_528 = ~n_528;
  end
  // __INJECTED_FAULT__ type=glitch net=n1099 delays=(7,13)
  initial begin
    #7 n1099 = ~n1099;
    #13 n1099 = ~n1099;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2762 delays=(12,15)
  initial begin
    #12 n_2762 = ~n_2762;
    #15 n_2762 = ~n_2762;
  end
  // __INJECTED_FAULT__ type=glitch net=n_51 delays=(11,13)
  initial begin
    #11 n_51 = ~n_51;
    #13 n_51 = ~n_51;
  end
  // __INJECTED_FAULT__ type=glitch net=n1493 delays=(1,7)
  initial begin
    #1 n1493 = ~n1493;
    #7 n1493 = ~n1493;
  end
  // __INJECTED_FAULT__ type=glitch net=n_233 delays=(1,7)
  initial begin
    #1 n_233 = ~n_233;
    #7 n_233 = ~n_233;
  end
  // __INJECTED_FAULT__ type=glitch net=n2756 delays=(7,15)
  initial begin
    #7 n2756 = ~n2756;
    #15 n2756 = ~n2756;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1694 delays=(19,25)
  initial begin
    #19 n_1694 = ~n_1694;
    #25 n_1694 = ~n_1694;
  end
  // __INJECTED_FAULT__ type=glitch net=n1367 delays=(8,17)
  initial begin
    #8 n1367 = ~n1367;
    #17 n1367 = ~n1367;
  end
  // __INJECTED_FAULT__ type=glitch net=n2031 delays=(3,10)
  initial begin
    #3 n2031 = ~n2031;
    #10 n2031 = ~n2031;
  end
  // __INJECTED_FAULT__ type=glitch net=n816 delays=(10,20)
  initial begin
    #10 n816 = ~n816;
    #20 n816 = ~n816;
  end
  // __INJECTED_FAULT__ type=glitch net=n1072 delays=(7,16)
  initial begin
    #7 n1072 = ~n1072;
    #16 n1072 = ~n1072;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1502 delays=(7,9)
  initial begin
    #7 n_1502 = ~n_1502;
    #9 n_1502 = ~n_1502;
  end
  // __INJECTED_FAULT__ type=glitch net=n982 delays=(18,23)
  initial begin
    #18 n982 = ~n982;
    #23 n982 = ~n982;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2701 delays=(20,22)
  initial begin
    #20 n_2701 = ~n_2701;
    #22 n_2701 = ~n_2701;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2241 delays=(19,26)
  initial begin
    #19 n_2241 = ~n_2241;
    #26 n_2241 = ~n_2241;
  end
  // __INJECTED_FAULT__ type=glitch net=n_72 delays=(14,20)
  initial begin
    #14 n_72 = ~n_72;
    #20 n_72 = ~n_72;
  end
  // __INJECTED_FAULT__ type=glitch net=n_2667 delays=(11,15)
  initial begin
    #11 n_2667 = ~n_2667;
    #15 n_2667 = ~n_2667;
  end
