...
module i2c(pi000, pi001, pi002, pi003, pi004, pi005, pi006, pi007,
  ...
  // __INJECTED_FAULT__ type=glitch net=n890 delays=(16,17)
  initial begin
    #16 n890 = ~n890;
    #17 n890 = ~n890;
  end
  // __INJECTED_FAULT__ type=glitch net=n1324 delays=(13,20)
  initial begin
    #13 n1324 = ~n1324;
    #20 n1324 = ~n1324;
  end
  // __INJECTED_FAULT__ type=glitch net=n419 delays=(3,8)
  initial begin
    #3 n419 = ~n419;
    #8 n419 = ~n419;
  end
  // __INJECTED_FAULT__ type=glitch net=n_79 delays=(20,29)
  initial begin
    #20 n_79 = ~n_79;
    #29 n_79 = ~n_79;
  end
  // __INJECTED_FAULT__ type=glitch net=n_405 delays=(5,14)
  initial begin
    #5 n_405 = ~n_405;
    #14 n_405 = ~n_405;
  end
  // __INJECTED_FAULT__ type=glitch net=n717 delays=(6,11)
  initial begin
    #6 n717 = ~n717;
    #11 n717 = ~n717;
  end
  // __INJECTED_FAULT__ type=glitch net=n_132 delays=(13,21)
  initial begin
    #13 n_132 = ~n_132;
    #21 n_132 = ~n_132;
  end
  // __INJECTED_FAULT__ type=glitch net=n908 delays=(10,18)
  initial begin
    #10 n908 = ~n908;
    #18 n908 = ~n908;
  end
  // __INJECTED_FAULT__ type=glitch net=n_42 delays=(10,17)
  initial begin
    #10 n_42 = ~n_42;
    #17 n_42 = ~n_42;
  end
  // __INJECTED_FAULT__ type=glitch net=n_875 delays=(18,28)
  initial begin
    #18 n_875 = ~n_875;
    #28 n_875 = ~n_875;
  end
  // __INJECTED_FAULT__ type=glitch net=po129 delays=(16,18)
  initial begin
    #16 po129 = ~po129;
    #18 po129 = ~po129;
  end
  // __INJECTED_FAULT__ type=glitch net=n_148 delays=(11,14)
  initial begin
    #11 n_148 = ~n_148;
    #14 n_148 = ~n_148;
  end
  // __INJECTED_FAULT__ type=glitch net=pi072 delays=(16,20)
  initial begin
    #16 pi072 = ~pi072;
    #20 pi072 = ~pi072;
  end
  // __INJECTED_FAULT__ type=glitch net=n_728 delays=(5,9)
  initial begin
    #5 n_728 = ~n_728;
    #9 n_728 = ~n_728;
  end
  // __INJECTED_FAULT__ type=glitch net=n_371 delays=(1,2)
  initial begin
    #1 n_371 = ~n_371;
    #2 n_371 = ~n_371;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1141 delays=(17,23)
  initial begin
    #17 n_1141 = ~n_1141;
    #23 n_1141 = ~n_1141;
  end
  // __INJECTED_FAULT__ type=glitch net=n1222 delays=(16,23)
  initial begin
    #16 n1222 = ~n1222;
    #23 n1222 = ~n1222;
  end
  // __INJECTED_FAULT__ type=glitch net=n_972 delays=(14,21)
  initial begin
    #14 n_972 = ~n_972;
    #21 n_972 = ~n_972;
  end
  // __INJECTED_FAULT__ type=glitch net=pi054 delays=(12,19)
  initial begin
    #12 pi054 = ~pi054;
    #19 pi054 = ~pi054;
  end
  // __INJECTED_FAULT__ type=glitch net=pi086 delays=(16,21)
  initial begin
    #16 pi086 = ~pi086;
    #21 pi086 = ~pi086;
  end
  // __INJECTED_FAULT__ type=glitch net=n658 delays=(19,21)
  initial begin
    #19 n658 = ~n658;
    #21 n658 = ~n658;
  end
  // __INJECTED_FAULT__ type=glitch net=n1601 delays=(14,15)
  initial begin
    #14 n1601 = ~n1601;
    #15 n1601 = ~n1601;
  end
  // __INJECTED_FAULT__ type=glitch net=n1245 delays=(4,11)
  initial begin
    #4 n1245 = ~n1245;
    #11 n1245 = ~n1245;
  end
  // __INJECTED_FAULT__ type=glitch net=n_626 delays=(19,22)
  initial begin
    #19 n_626 = ~n_626;
    #22 n_626 = ~n_626;
  end
  // __INJECTED_FAULT__ type=glitch net=n1280 delays=(7,14)
  initial begin
    #7 n1280 = ~n1280;
    #14 n1280 = ~n1280;
  end
  // __INJECTED_FAULT__ type=glitch net=n338 delays=(9,15)
  initial begin
    #9 n338 = ~n338;
    #15 n338 = ~n338;
  end
  // __INJECTED_FAULT__ type=glitch net=po098 delays=(17,25)
  initial begin
    #17 po098 = ~po098;
    #25 po098 = ~po098;
  end
  // __INJECTED_FAULT__ type=glitch net=n736 delays=(12,13)
  initial begin
    #12 n736 = ~n736;
    #13 n736 = ~n736;
  end
  // __INJECTED_FAULT__ type=glitch net=n_339 delays=(13,20)
  initial begin
    #13 n_339 = ~n_339;
    #20 n_339 = ~n_339;
  end
  // __INJECTED_FAULT__ type=glitch net=n_948 delays=(8,12)
  initial begin
    #8 n_948 = ~n_948;
    #12 n_948 = ~n_948;
  end
  // __INJECTED_FAULT__ type=glitch net=n1539 delays=(16,17)
  initial begin
    #16 n1539 = ~n1539;
    #17 n1539 = ~n1539;
  end
  // __INJECTED_FAULT__ type=glitch net=n1053 delays=(12,13)
  initial begin
    #12 n1053 = ~n1053;
    #13 n1053 = ~n1053;
  end
  // __INJECTED_FAULT__ type=glitch net=n803 delays=(5,10)
  initial begin
    #5 n803 = ~n803;
    #10 n803 = ~n803;
  end
  // __INJECTED_FAULT__ type=glitch net=n_344 delays=(20,28)
  initial begin
    #20 n_344 = ~n_344;
    #28 n_344 = ~n_344;
  end
  // __INJECTED_FAULT__ type=glitch net=n1066 delays=(5,10)
  initial begin
    #5 n1066 = ~n1066;
    #10 n1066 = ~n1066;
  end
  // __INJECTED_FAULT__ type=glitch net=po008 delays=(8,18)
  initial begin
    #8 po008 = ~po008;
    #18 po008 = ~po008;
  end
  // __INJECTED_FAULT__ type=glitch net=n1252 delays=(19,22)
  initial begin
    #19 n1252 = ~n1252;
    #22 n1252 = ~n1252;
  end
  // __INJECTED_FAULT__ type=glitch net=n_704 delays=(1,3)
  initial begin
    #1 n_704 = ~n_704;
    #3 n_704 = ~n_704;
  end
  // __INJECTED_FAULT__ type=glitch net=n_108 delays=(3,10)
  initial begin
    #3 n_108 = ~n_108;
    #10 n_108 = ~n_108;
  end
  // __INJECTED_FAULT__ type=glitch net=n722 delays=(13,23)
  initial begin
    #13 n722 = ~n722;
    #23 n722 = ~n722;
  end
  // __INJECTED_FAULT__ type=glitch net=n1458 delays=(3,12)
  initial begin
    #3 n1458 = ~n1458;
    #12 n1458 = ~n1458;
  end
  // __INJECTED_FAULT__ type=glitch net=n_39 delays=(7,14)
  initial begin
    #7 n_39 = ~n_39;
    #14 n_39 = ~n_39;
  end
  // __INJECTED_FAULT__ type=glitch net=po015 delays=(6,13)
  initial begin
    #6 po015 = ~po015;
    #13 po015 = ~po015;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1186 delays=(9,14)
  initial begin
    #9 n_1186 = ~n_1186;
    #14 n_1186 = ~n_1186;
  end
  // __INJECTED_FAULT__ type=glitch net=n_556 delays=(17,26)
  initial begin
    #17 n_556 = ~n_556;
    #26 n_556 = ~n_556;
  end
  // __INJECTED_FAULT__ type=glitch net=n1503 delays=(13,23)
  initial begin
    #13 n1503 = ~n1503;
    #23 n1503 = ~n1503;
  end
  // __INJECTED_FAULT__ type=glitch net=pi097 delays=(10,17)
  initial begin
    #10 pi097 = ~pi097;
    #17 pi097 = ~pi097;
  end
  // __INJECTED_FAULT__ type=glitch net=n1201 delays=(3,5)
  initial begin
    #3 n1201 = ~n1201;
    #5 n1201 = ~n1201;
  end
  // __INJECTED_FAULT__ type=glitch net=n_127 delays=(19,25)
  initial begin
    #19 n_127 = ~n_127;
    #25 n_127 = ~n_127;
  end
  // __INJECTED_FAULT__ type=glitch net=n_183 delays=(5,10)
  initial begin
    #5 n_183 = ~n_183;
    #10 n_183 = ~n_183;
  end
  // __INJECTED_FAULT__ type=glitch net=n1273 delays=(7,14)
  initial begin
    #7 n1273 = ~n1273;
    #14 n1273 = ~n1273;
  end
  // __INJECTED_FAULT__ type=glitch net=n1072 delays=(10,11)
  initial begin
    #10 n1072 = ~n1072;
    #11 n1072 = ~n1072;
  end
  // __INJECTED_FAULT__ type=glitch net=po074 delays=(6,14)
  initial begin
    #6 po074 = ~po074;
    #14 po074 = ~po074;
  end
  // __INJECTED_FAULT__ type=glitch net=n1305 delays=(1,3)
  initial begin
    #1 n1305 = ~n1305;
    #3 n1305 = ~n1305;
  end
  // __INJECTED_FAULT__ type=glitch net=n1173 delays=(3,10)
  initial begin
    #3 n1173 = ~n1173;
    #10 n1173 = ~n1173;
  end
  // __INJECTED_FAULT__ type=glitch net=n_367 delays=(17,24)
  initial begin
    #17 n_367 = ~n_367;
    #24 n_367 = ~n_367;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1188 delays=(10,17)
  initial begin
    #10 n_1188 = ~n_1188;
    #17 n_1188 = ~n_1188;
  end
  // __INJECTED_FAULT__ type=glitch net=n_62 delays=(6,9)
  initial begin
    #6 n_62 = ~n_62;
    #9 n_62 = ~n_62;
  end
  // __INJECTED_FAULT__ type=glitch net=n951 delays=(12,15)
  initial begin
    #12 n951 = ~n951;
    #15 n951 = ~n951;
  end
  // __INJECTED_FAULT__ type=glitch net=n_697 delays=(5,9)
  initial begin
    #5 n_697 = ~n_697;
    #9 n_697 = ~n_697;
  end
  // __INJECTED_FAULT__ type=glitch net=pi024 delays=(16,19)
  initial begin
    #16 pi024 = ~pi024;
    #19 pi024 = ~pi024;
  end
  // __INJECTED_FAULT__ type=glitch net=po117 delays=(17,19)
  initial begin
    #17 po117 = ~po117;
    #19 po117 = ~po117;
  end
  // __INJECTED_FAULT__ type=glitch net=n_915 delays=(15,25)
  initial begin
    #15 n_915 = ~n_915;
    #25 n_915 = ~n_915;
  end
  // __INJECTED_FAULT__ type=glitch net=po139 delays=(7,10)
  initial begin
    #7 po139 = ~po139;
    #10 po139 = ~po139;
  end
  // __INJECTED_FAULT__ type=glitch net=n1003 delays=(7,8)
  initial begin
    #7 n1003 = ~n1003;
    #8 n1003 = ~n1003;
  end
  // __INJECTED_FAULT__ type=glitch net=po066 delays=(6,10)
  initial begin
    #6 po066 = ~po066;
    #10 po066 = ~po066;
  end
  // __INJECTED_FAULT__ type=glitch net=n752 delays=(9,16)
  initial begin
    #9 n752 = ~n752;
    #16 n752 = ~n752;
  end
  // __INJECTED_FAULT__ type=glitch net=n1065 delays=(15,25)
  initial begin
    #15 n1065 = ~n1065;
    #25 n1065 = ~n1065;
  end
  // __INJECTED_FAULT__ type=glitch net=n670 delays=(4,7)
  initial begin
    #4 n670 = ~n670;
    #7 n670 = ~n670;
  end
  // __INJECTED_FAULT__ type=glitch net=n405 delays=(3,8)
  initial begin
    #3 n405 = ~n405;
    #8 n405 = ~n405;
  end
  // __INJECTED_FAULT__ type=glitch net=n900 delays=(3,10)
  initial begin
    #3 n900 = ~n900;
    #10 n900 = ~n900;
  end
  // __INJECTED_FAULT__ type=glitch net=n1238 delays=(4,9)
  initial begin
    #4 n1238 = ~n1238;
    #9 n1238 = ~n1238;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1125 delays=(3,9)
  initial begin
    #3 n_1125 = ~n_1125;
    #9 n_1125 = ~n_1125;
  end
  // __INJECTED_FAULT__ type=glitch net=n333 delays=(1,11)
  initial begin
    #1 n333 = ~n333;
    #11 n333 = ~n333;
  end
  // __INJECTED_FAULT__ type=glitch net=n_616 delays=(8,16)
  initial begin
    #8 n_616 = ~n_616;
    #16 n_616 = ~n_616;
  end
  // __INJECTED_FAULT__ type=glitch net=n_812 delays=(16,18)
  initial begin
    #16 n_812 = ~n_812;
    #18 n_812 = ~n_812;
  end
  // __INJECTED_FAULT__ type=glitch net=n1620 delays=(1,2)
  initial begin
    #1 n1620 = ~n1620;
    #2 n1620 = ~n1620;
  end
  // __INJECTED_FAULT__ type=glitch net=n855 delays=(9,10)
  initial begin
    #9 n855 = ~n855;
    #10 n855 = ~n855;
  end
  // __INJECTED_FAULT__ type=glitch net=n1030 delays=(19,20)
  initial begin
    #19 n1030 = ~n1030;
    #20 n1030 = ~n1030;
  end
  // __INJECTED_FAULT__ type=glitch net=n1287 delays=(4,8)
  initial begin
    #4 n1287 = ~n1287;
    #8 n1287 = ~n1287;
  end
  // __INJECTED_FAULT__ type=glitch net=n_604 delays=(17,18)
  initial begin
    #17 n_604 = ~n_604;
    #18 n_604 = ~n_604;
  end
  // __INJECTED_FAULT__ type=glitch net=n913 delays=(13,23)
  initial begin
    #13 n913 = ~n913;
    #23 n913 = ~n913;
  end
  // __INJECTED_FAULT__ type=glitch net=n1308 delays=(17,22)
  initial begin
    #17 n1308 = ~n1308;
    #22 n1308 = ~n1308;
  end
  // __INJECTED_FAULT__ type=glitch net=n1567 delays=(16,24)
  initial begin
    #16 n1567 = ~n1567;
    #24 n1567 = ~n1567;
  end
  // __INJECTED_FAULT__ type=glitch net=n1489 delays=(11,21)
  initial begin
    #11 n1489 = ~n1489;
    #21 n1489 = ~n1489;
  end
  // __INJECTED_FAULT__ type=glitch net=n_725 delays=(14,20)
  initial begin
    #14 n_725 = ~n_725;
    #20 n_725 = ~n_725;
  end
  // __INJECTED_FAULT__ type=glitch net=n1050 delays=(12,18)
  initial begin
    #12 n1050 = ~n1050;
    #18 n1050 = ~n1050;
  end
  // __INJECTED_FAULT__ type=glitch net=n1426 delays=(11,15)
  initial begin
    #11 n1426 = ~n1426;
    #15 n1426 = ~n1426;
  end
  // __INJECTED_FAULT__ type=glitch net=n_870 delays=(12,19)
  initial begin
    #12 n_870 = ~n_870;
    #19 n_870 = ~n_870;
  end
  // __INJECTED_FAULT__ type=glitch net=n341 delays=(13,23)
  initial begin
    #13 n341 = ~n341;
    #23 n341 = ~n341;
  end
  // __INJECTED_FAULT__ type=glitch net=n_266 delays=(2,8)
  initial begin
    #2 n_266 = ~n_266;
    #8 n_266 = ~n_266;
  end
  // __INJECTED_FAULT__ type=glitch net=n_455 delays=(11,13)
  initial begin
    #11 n_455 = ~n_455;
    #13 n_455 = ~n_455;
  end
  // __INJECTED_FAULT__ type=glitch net=n_352 delays=(1,9)
  initial begin
    #1 n_352 = ~n_352;
    #9 n_352 = ~n_352;
  end
  // __INJECTED_FAULT__ type=glitch net=n872 delays=(13,16)
  initial begin
    #13 n872 = ~n872;
    #16 n872 = ~n872;
  end
  // __INJECTED_FAULT__ type=glitch net=n_828 delays=(1,11)
  initial begin
    #1 n_828 = ~n_828;
    #11 n_828 = ~n_828;
  end
  // __INJECTED_FAULT__ type=glitch net=n_692 delays=(4,13)
  initial begin
    #4 n_692 = ~n_692;
    #13 n_692 = ~n_692;
  end
  // __INJECTED_FAULT__ type=glitch net=n_598 delays=(9,13)
  initial begin
    #9 n_598 = ~n_598;
    #13 n_598 = ~n_598;
  end
  // __INJECTED_FAULT__ type=glitch net=n_1116 delays=(12,20)
  initial begin
    #12 n_1116 = ~n_1116;
    #20 n_1116 = ~n_1116;
  end
  // __INJECTED_FAULT__ type=glitch net=n_648 delays=(20,28)
  initial begin
    #20 n_648 = ~n_648;
    #28 n_648 = ~n_648;
  end
  // __INJECTED_FAULT__ type=glitch net=n820 delays=(17,24)
  initial begin
    #17 n820 = ~n820;
    #24 n820 = ~n820;
  end
