...
module ctrl(\opcode[0] , \opcode[1] , \opcode[2] , \opcode[3] ,
  ...
  // __INJECTED_FAULT__ type=glitch net=n169 delays=(16,18)
  initial begin
    #16 n169 = ~n169;
    #18 n169 = ~n169;
  end
  // __INJECTED_FAULT__ type=glitch net=n_118 delays=(16,26)
  initial begin
    #16 n_118 = ~n_118;
    #26 n_118 = ~n_118;
  end
  // __INJECTED_FAULT__ type=glitch net=n_25 delays=(12,20)
  initial begin
    #12 n_25 = ~n_25;
    #20 n_25 = ~n_25;
  end
  // __INJECTED_FAULT__ type=glitch net=jump delays=(14,15)
  initial begin
    #14 jump = ~jump;
    #15 jump = ~jump;
  end
  // __INJECTED_FAULT__ type=glitch net=n193 delays=(6,11)
  initial begin
    #6 n193 = ~n193;
    #11 n193 = ~n193;
  end
  // __INJECTED_FAULT__ type=glitch net=\opcode[4] delays=(7,15)
  initial begin
    #7 \opcode[4] = ~\opcode[4];
    #15 \opcode[4] = ~\opcode[4];
  end
  // __INJECTED_FAULT__ type=glitch net=n55 delays=(12,20)
  initial begin
    #12 n55 = ~n55;
    #20 n55 = ~n55;
  end
  // __INJECTED_FAULT__ type=glitch net=n_46 delays=(8,17)
  initial begin
    #8 n_46 = ~n_46;
    #17 n_46 = ~n_46;
  end
  // __INJECTED_FAULT__ type=glitch net=n_37 delays=(8,18)
  initial begin
    #8 n_37 = ~n_37;
    #18 n_37 = ~n_37;
  end
  // __INJECTED_FAULT__ type=glitch net=n_80 delays=(11,21)
  initial begin
    #11 n_80 = ~n_80;
    #21 n_80 = ~n_80;
  end
  // __INJECTED_FAULT__ type=glitch net=n_123 delays=(15,18)
  initial begin
    #15 n_123 = ~n_123;
    #18 n_123 = ~n_123;
  end
  // __INJECTED_FAULT__ type=glitch net=n_132 delays=(10,17)
  initial begin
    #10 n_132 = ~n_132;
    #17 n_132 = ~n_132;
  end
  // __INJECTED_FAULT__ type=glitch net=n_110 delays=(14,20)
  initial begin
    #14 n_110 = ~n_110;
    #20 n_110 = ~n_110;
  end
  // __INJECTED_FAULT__ type=glitch net=n166 delays=(16,19)
  initial begin
    #16 n166 = ~n166;
    #19 n166 = ~n166;
  end
  // __INJECTED_FAULT__ type=glitch net=halt delays=(20,24)
  initial begin
    #20 halt = ~halt;
    #24 halt = ~halt;
  end
  // __INJECTED_FAULT__ type=glitch net=n_76 delays=(10,12)
  initial begin
    #10 n_76 = ~n_76;
    #12 n_76 = ~n_76;
  end
  // __INJECTED_FAULT__ type=glitch net=n_29 delays=(16,19)
  initial begin
    #16 n_29 = ~n_29;
    #19 n_29 = ~n_29;
  end
  // __INJECTED_FAULT__ type=glitch net=n_75 delays=(6,10)
  initial begin
    #6 n_75 = ~n_75;
    #10 n_75 = ~n_75;
  end
  // __INJECTED_FAULT__ type=glitch net=n_89 delays=(6,16)
  initial begin
    #6 n_89 = ~n_89;
    #16 n_89 = ~n_89;
  end
  // __INJECTED_FAULT__ type=glitch net=n_129 delays=(16,18)
  initial begin
    #16 n_129 = ~n_129;
    #18 n_129 = ~n_129;
  end
  // __INJECTED_FAULT__ type=glitch net=n_140 delays=(14,22)
  initial begin
    #14 n_140 = ~n_140;
    #22 n_140 = ~n_140;
  end
  // __INJECTED_FAULT__ type=glitch net=n128 delays=(10,14)
  initial begin
    #10 n128 = ~n128;
    #14 n128 = ~n128;
  end
  // __INJECTED_FAULT__ type=glitch net=mem_write delays=(7,16)
  initial begin
    #7 mem_write = ~mem_write;
    #16 mem_write = ~mem_write;
  end
  // __INJECTED_FAULT__ type=glitch net=n_97 delays=(2,3)
  initial begin
    #2 n_97 = ~n_97;
    #3 n_97 = ~n_97;
  end
  // __INJECTED_FAULT__ type=glitch net=\sel_alu_opB[0] delays=(12,17)
  initial begin
    #12 \sel_alu_opB[0] = ~\sel_alu_opB[0];
    #17 \sel_alu_opB[0] = ~\sel_alu_opB[0];
  end
  // __INJECTED_FAULT__ type=glitch net=n_41 delays=(12,15)
  initial begin
    #12 n_41 = ~n_41;
    #15 n_41 = ~n_41;
  end
  // __INJECTED_FAULT__ type=glitch net=n_122 delays=(6,15)
  initial begin
    #6 n_122 = ~n_122;
    #15 n_122 = ~n_122;
  end
  // __INJECTED_FAULT__ type=glitch net=n183 delays=(2,4)
  initial begin
    #2 n183 = ~n183;
    #4 n183 = ~n183;
  end
  // __INJECTED_FAULT__ type=glitch net=sel_wb delays=(11,18)
  initial begin
    #11 sel_wb = ~sel_wb;
    #18 sel_wb = ~sel_wb;
  end
  // __INJECTED_FAULT__ type=glitch net=n151 delays=(4,14)
  initial begin
    #4 n151 = ~n151;
    #14 n151 = ~n151;
  end
  // __INJECTED_FAULT__ type=glitch net=n_38 delays=(8,10)
  initial begin
    #8 n_38 = ~n_38;
    #10 n_38 = ~n_38;
  end
