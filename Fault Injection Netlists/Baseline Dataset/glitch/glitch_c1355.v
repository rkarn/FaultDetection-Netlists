...
module c1355(G1, G10, G11, G12, G13, G1324, G1325, G1326, G1327, G1328,
  ...
  // __INJECTED_FAULT__ type=glitch net=G1201 delays=(11,18)
  initial begin
    #11 G1201 = ~G1201;
    #18 G1201 = ~G1201;
  end
  // __INJECTED_FAULT__ type=glitch net=G809 delays=(4,5)
  initial begin
    #4 G809 = ~G809;
    #5 G809 = ~G809;
  end
  // __INJECTED_FAULT__ type=glitch net=G1171 delays=(4,9)
  initial begin
    #4 G1171 = ~G1171;
    #9 G1171 = ~G1171;
  end
  // __INJECTED_FAULT__ type=glitch net=G388 delays=(8,17)
  initial begin
    #8 G388 = ~G388;
    #17 G388 = ~G388;
  end
  // __INJECTED_FAULT__ type=glitch net=G736 delays=(17,26)
  initial begin
    #17 G736 = ~G736;
    #26 G736 = ~G736;
  end
  // __INJECTED_FAULT__ type=glitch net=G769 delays=(19,29)
  initial begin
    #19 G769 = ~G769;
    #29 G769 = ~G769;
  end
  // __INJECTED_FAULT__ type=glitch net=G510 delays=(8,16)
  initial begin
    #8 G510 = ~G510;
    #16 G510 = ~G510;
  end
  // __INJECTED_FAULT__ type=glitch net=G1259 delays=(12,19)
  initial begin
    #12 G1259 = ~G1259;
    #19 G1259 = ~G1259;
  end
  // __INJECTED_FAULT__ type=glitch net=G762 delays=(15,25)
  initial begin
    #15 G762 = ~G762;
    #25 G762 = ~G762;
  end
  // __INJECTED_FAULT__ type=glitch net=G438 delays=(17,20)
  initial begin
    #17 G438 = ~G438;
    #20 G438 = ~G438;
  end
  // __INJECTED_FAULT__ type=glitch net=G1072 delays=(12,13)
  initial begin
    #12 G1072 = ~G1072;
    #13 G1072 = ~G1072;
  end
  // __INJECTED_FAULT__ type=glitch net=G767 delays=(16,18)
  initial begin
    #16 G767 = ~G767;
    #18 G767 = ~G767;
  end
  // __INJECTED_FAULT__ type=glitch net=G709 delays=(10,17)
  initial begin
    #10 G709 = ~G709;
    #17 G709 = ~G709;
  end
  // __INJECTED_FAULT__ type=glitch net=G1271 delays=(3,5)
  initial begin
    #3 G1271 = ~G1271;
    #5 G1271 = ~G1271;
  end
  // __INJECTED_FAULT__ type=glitch net=G593 delays=(5,11)
  initial begin
    #5 G593 = ~G593;
    #11 G593 = ~G593;
  end
  // __INJECTED_FAULT__ type=glitch net=G782 delays=(10,16)
  initial begin
    #10 G782 = ~G782;
    #16 G782 = ~G782;
  end
  // __INJECTED_FAULT__ type=glitch net=G986 delays=(15,19)
  initial begin
    #15 G986 = ~G986;
    #19 G986 = ~G986;
  end
  // __INJECTED_FAULT__ type=glitch net=G696 delays=(17,25)
  initial begin
    #17 G696 = ~G696;
    #25 G696 = ~G696;
  end
  // __INJECTED_FAULT__ type=glitch net=G1057 delays=(12,20)
  initial begin
    #12 G1057 = ~G1057;
    #20 G1057 = ~G1057;
  end
  // __INJECTED_FAULT__ type=glitch net=G950 delays=(4,12)
  initial begin
    #4 G950 = ~G950;
    #12 G950 = ~G950;
  end
  // __INJECTED_FAULT__ type=glitch net=G365 delays=(15,21)
  initial begin
    #15 G365 = ~G365;
    #21 G365 = ~G365;
  end
  // __INJECTED_FAULT__ type=glitch net=G507 delays=(3,8)
  initial begin
    #3 G507 = ~G507;
    #8 G507 = ~G507;
  end
  // __INJECTED_FAULT__ type=glitch net=n_80 delays=(2,4)
  initial begin
    #2 n_80 = ~n_80;
    #4 n_80 = ~n_80;
  end
  // __INJECTED_FAULT__ type=glitch net=G447 delays=(1,7)
  initial begin
    #1 G447 = ~G447;
    #7 G447 = ~G447;
  end
  // __INJECTED_FAULT__ type=glitch net=G34 delays=(4,7)
  initial begin
    #4 G34 = ~G34;
    #7 G34 = ~G34;
  end
  // __INJECTED_FAULT__ type=glitch net=G1241 delays=(8,17)
  initial begin
    #8 G1241 = ~G1241;
    #17 G1241 = ~G1241;
  end
  // __INJECTED_FAULT__ type=glitch net=G537 delays=(6,15)
  initial begin
    #6 G537 = ~G537;
    #15 G537 = ~G537;
  end
  // __INJECTED_FAULT__ type=glitch net=G1195 delays=(6,12)
  initial begin
    #6 G1195 = ~G1195;
    #12 G1195 = ~G1195;
  end
  // __INJECTED_FAULT__ type=glitch net=G1353 delays=(18,25)
  initial begin
    #18 G1353 = ~G1353;
    #25 G1353 = ~G1353;
  end
  // __INJECTED_FAULT__ type=glitch net=G1105 delays=(15,19)
  initial begin
    #15 G1105 = ~G1105;
    #19 G1105 = ~G1105;
  end
  // __INJECTED_FAULT__ type=glitch net=G1280 delays=(13,16)
  initial begin
    #13 G1280 = ~G1280;
    #16 G1280 = ~G1280;
  end
  // __INJECTED_FAULT__ type=glitch net=G391 delays=(6,13)
  initial begin
    #6 G391 = ~G391;
    #13 G391 = ~G391;
  end
  // __INJECTED_FAULT__ type=glitch net=G745 delays=(13,14)
  initial begin
    #13 G745 = ~G745;
    #14 G745 = ~G745;
  end
  // __INJECTED_FAULT__ type=glitch net=G592 delays=(20,24)
  initial begin
    #20 G592 = ~G592;
    #24 G592 = ~G592;
  end
  // __INJECTED_FAULT__ type=glitch net=G607 delays=(15,25)
  initial begin
    #15 G607 = ~G607;
    #25 G607 = ~G607;
  end
  // __INJECTED_FAULT__ type=glitch net=G406 delays=(14,21)
  initial begin
    #14 G406 = ~G406;
    #21 G406 = ~G406;
  end
  // __INJECTED_FAULT__ type=glitch net=G1150 delays=(1,5)
  initial begin
    #1 G1150 = ~G1150;
    #5 G1150 = ~G1150;
  end
  // __INJECTED_FAULT__ type=glitch net=G991 delays=(7,12)
  initial begin
    #7 G991 = ~G991;
    #12 G991 = ~G991;
  end
  // __INJECTED_FAULT__ type=glitch net=G248 delays=(3,13)
  initial begin
    #3 G248 = ~G248;
    #13 G248 = ~G248;
  end
  // __INJECTED_FAULT__ type=glitch net=G1228 delays=(4,13)
  initial begin
    #4 G1228 = ~G1228;
    #13 G1228 = ~G1228;
  end
  // __INJECTED_FAULT__ type=glitch net=G1081 delays=(6,12)
  initial begin
    #6 G1081 = ~G1081;
    #12 G1081 = ~G1081;
  end
  // __INJECTED_FAULT__ type=glitch net=G1316 delays=(11,15)
  initial begin
    #11 G1316 = ~G1316;
    #15 G1316 = ~G1316;
  end
  // __INJECTED_FAULT__ type=glitch net=G1287 delays=(15,17)
  initial begin
    #15 G1287 = ~G1287;
    #17 G1287 = ~G1287;
  end
  // __INJECTED_FAULT__ type=glitch net=G1135 delays=(9,17)
  initial begin
    #9 G1135 = ~G1135;
    #17 G1135 = ~G1135;
  end
  // __INJECTED_FAULT__ type=glitch net=n_76 delays=(17,23)
  initial begin
    #17 n_76 = ~n_76;
    #23 n_76 = ~n_76;
  end
  // __INJECTED_FAULT__ type=glitch net=G6 delays=(20,27)
  initial begin
    #20 G6 = ~G6;
    #27 G6 = ~G6;
  end
  // __INJECTED_FAULT__ type=glitch net=G925 delays=(20,27)
  initial begin
    #20 G925 = ~G925;
    #27 G925 = ~G925;
  end
  // __INJECTED_FAULT__ type=glitch net=G1318 delays=(19,21)
  initial begin
    #19 G1318 = ~G1318;
    #21 G1318 = ~G1318;
  end
  // __INJECTED_FAULT__ type=glitch net=G284 delays=(12,18)
  initial begin
    #12 G284 = ~G284;
    #18 G284 = ~G284;
  end
  // __INJECTED_FAULT__ type=glitch net=G356 delays=(15,25)
  initial begin
    #15 G356 = ~G356;
    #25 G356 = ~G356;
  end
  // __INJECTED_FAULT__ type=glitch net=G599 delays=(6,11)
  initial begin
    #6 G599 = ~G599;
    #11 G599 = ~G599;
  end
  // __INJECTED_FAULT__ type=glitch net=G860 delays=(20,30)
  initial begin
    #20 G860 = ~G860;
    #30 G860 = ~G860;
  end
  // __INJECTED_FAULT__ type=glitch net=G419 delays=(3,6)
  initial begin
    #3 G419 = ~G419;
    #6 G419 = ~G419;
  end
  // __INJECTED_FAULT__ type=glitch net=G1328 delays=(11,13)
  initial begin
    #11 G1328 = ~G1328;
    #13 G1328 = ~G1328;
  end
  // __INJECTED_FAULT__ type=glitch net=G1078 delays=(8,13)
  initial begin
    #8 G1078 = ~G1078;
    #13 G1078 = ~G1078;
  end
