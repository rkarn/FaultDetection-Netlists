...
module router(\dest_x[0] , \dest_x[1] , \dest_x[2] , \dest_x[3] ,
  ...
  // __INJECTED_FAULT__ type=glitch net=n241 delays=(1,11)
  initial begin
    #1 n241 = ~n241;
    #11 n241 = ~n241;
  end
  // __INJECTED_FAULT__ type=glitch net=n_73 delays=(5,8)
  initial begin
    #5 n_73 = ~n_73;
    #8 n_73 = ~n_73;
  end
  // __INJECTED_FAULT__ type=glitch net=n101 delays=(5,7)
  initial begin
    #5 n101 = ~n101;
    #7 n101 = ~n101;
  end
  // __INJECTED_FAULT__ type=glitch net=\dest_x[2] delays=(14,16)
  initial begin
    #14 \dest_x[2] = ~\dest_x[2];
    #16 \dest_x[2] = ~\dest_x[2];
  end
  // __INJECTED_FAULT__ type=glitch net=n_113 delays=(2,10)
  initial begin
    #2 n_113 = ~n_113;
    #10 n_113 = ~n_113;
  end
  // __INJECTED_FAULT__ type=glitch net=n214 delays=(2,8)
  initial begin
    #2 n214 = ~n214;
    #8 n214 = ~n214;
  end
  // __INJECTED_FAULT__ type=glitch net=n225 delays=(4,13)
  initial begin
    #4 n225 = ~n225;
    #13 n225 = ~n225;
  end
  // __INJECTED_FAULT__ type=glitch net=\dest_y[18] delays=(9,13)
  initial begin
    #9 \dest_y[18] = ~\dest_y[18];
    #13 \dest_y[18] = ~\dest_y[18];
  end
  // __INJECTED_FAULT__ type=glitch net=n245 delays=(20,21)
  initial begin
    #20 n245 = ~n245;
    #21 n245 = ~n245;
  end
  // __INJECTED_FAULT__ type=glitch net=n131 delays=(11,17)
  initial begin
    #11 n131 = ~n131;
    #17 n131 = ~n131;
  end
  // __INJECTED_FAULT__ type=glitch net=n_57 delays=(6,16)
  initial begin
    #6 n_57 = ~n_57;
    #16 n_57 = ~n_57;
  end
  // __INJECTED_FAULT__ type=glitch net=\dest_x[6] delays=(12,21)
  initial begin
    #12 \dest_x[6] = ~\dest_x[6];
    #21 \dest_x[6] = ~\dest_x[6];
  end
  // __INJECTED_FAULT__ type=glitch net=n_165 delays=(1,8)
  initial begin
    #1 n_165 = ~n_165;
    #8 n_165 = ~n_165;
  end
  // __INJECTED_FAULT__ type=glitch net=n141 delays=(14,15)
  initial begin
    #14 n141 = ~n141;
    #15 n141 = ~n141;
  end
  // __INJECTED_FAULT__ type=glitch net=\dest_x[17] delays=(3,7)
  initial begin
    #3 \dest_x[17] = ~\dest_x[17];
    #7 \dest_x[17] = ~\dest_x[17];
  end
  // __INJECTED_FAULT__ type=glitch net=n_203 delays=(17,20)
  initial begin
    #17 n_203 = ~n_203;
    #20 n_203 = ~n_203;
  end
  // __INJECTED_FAULT__ type=glitch net=n142 delays=(9,11)
  initial begin
    #9 n142 = ~n142;
    #11 n142 = ~n142;
  end
  // __INJECTED_FAULT__ type=glitch net=n_200 delays=(6,14)
  initial begin
    #6 n_200 = ~n_200;
    #14 n_200 = ~n_200;
  end
  // __INJECTED_FAULT__ type=glitch net=n_41 delays=(2,7)
  initial begin
    #2 n_41 = ~n_41;
    #7 n_41 = ~n_41;
  end
  // __INJECTED_FAULT__ type=glitch net=n260 delays=(20,24)
  initial begin
    #20 n260 = ~n260;
    #24 n260 = ~n260;
  end
  // __INJECTED_FAULT__ type=glitch net=\dest_x[22] delays=(17,24)
  initial begin
    #17 \dest_x[22] = ~\dest_x[22];
    #24 \dest_x[22] = ~\dest_x[22];
  end
  // __INJECTED_FAULT__ type=glitch net=n_228 delays=(6,7)
  initial begin
    #6 n_228 = ~n_228;
    #7 n_228 = ~n_228;
  end
  // __INJECTED_FAULT__ type=glitch net=n_232 delays=(10,15)
  initial begin
    #10 n_232 = ~n_232;
    #15 n_232 = ~n_232;
  end
  // __INJECTED_FAULT__ type=glitch net=n_184 delays=(18,24)
  initial begin
    #18 n_184 = ~n_184;
    #24 n_184 = ~n_184;
  end
  // __INJECTED_FAULT__ type=glitch net=\dest_x[29] delays=(4,10)
  initial begin
    #4 \dest_x[29] = ~\dest_x[29];
    #10 \dest_x[29] = ~\dest_x[29];
  end
  // __INJECTED_FAULT__ type=glitch net=n_103 delays=(15,25)
  initial begin
    #15 n_103 = ~n_103;
    #25 n_103 = ~n_103;
  end
  // __INJECTED_FAULT__ type=glitch net=n_331 delays=(3,13)
  initial begin
    #3 n_331 = ~n_331;
    #13 n_331 = ~n_331;
  end
  // __INJECTED_FAULT__ type=glitch net=\dest_x[15] delays=(15,17)
  initial begin
    #15 \dest_x[15] = ~\dest_x[15];
    #17 \dest_x[15] = ~\dest_x[15];
  end
  // __INJECTED_FAULT__ type=glitch net=n_351 delays=(4,6)
  initial begin
    #4 n_351 = ~n_351;
    #6 n_351 = ~n_351;
  end
  // __INJECTED_FAULT__ type=glitch net=n_239 delays=(6,8)
  initial begin
    #6 n_239 = ~n_239;
    #8 n_239 = ~n_239;
  end
  // __INJECTED_FAULT__ type=glitch net=n_36 delays=(6,12)
  initial begin
    #6 n_36 = ~n_36;
    #12 n_36 = ~n_36;
  end
  // __INJECTED_FAULT__ type=glitch net=n_167 delays=(19,20)
  initial begin
    #19 n_167 = ~n_167;
    #20 n_167 = ~n_167;
  end
  // __INJECTED_FAULT__ type=glitch net=n_191 delays=(6,7)
  initial begin
    #6 n_191 = ~n_191;
    #7 n_191 = ~n_191;
  end
  // __INJECTED_FAULT__ type=glitch net=n343 delays=(7,13)
  initial begin
    #7 n343 = ~n343;
    #13 n343 = ~n343;
  end
  // __INJECTED_FAULT__ type=glitch net=n_49 delays=(15,17)
  initial begin
    #15 n_49 = ~n_49;
    #17 n_49 = ~n_49;
  end
  // __INJECTED_FAULT__ type=glitch net=\outport[28] delays=(8,13)
  initial begin
    #8 \outport[28] = ~\outport[28];
    #13 \outport[28] = ~\outport[28];
  end
  // __INJECTED_FAULT__ type=glitch net=n_37 delays=(7,10)
  initial begin
    #7 n_37 = ~n_37;
    #10 n_37 = ~n_37;
  end
  // __INJECTED_FAULT__ type=glitch net=n_293 delays=(10,11)
  initial begin
    #10 n_293 = ~n_293;
    #11 n_293 = ~n_293;
  end
  // __INJECTED_FAULT__ type=glitch net=n_357 delays=(13,18)
  initial begin
    #13 n_357 = ~n_357;
    #18 n_357 = ~n_357;
  end
  // __INJECTED_FAULT__ type=glitch net=n_294 delays=(6,11)
  initial begin
    #6 n_294 = ~n_294;
    #11 n_294 = ~n_294;
  end
  // __INJECTED_FAULT__ type=glitch net=n_86 delays=(5,15)
  initial begin
    #5 n_86 = ~n_86;
    #15 n_86 = ~n_86;
  end
  // __INJECTED_FAULT__ type=glitch net=n_323 delays=(11,18)
  initial begin
    #11 n_323 = ~n_323;
    #18 n_323 = ~n_323;
  end
  // __INJECTED_FAULT__ type=glitch net=\dest_y[23] delays=(8,12)
  initial begin
    #8 \dest_y[23] = ~\dest_y[23];
    #12 \dest_y[23] = ~\dest_y[23];
  end
  // __INJECTED_FAULT__ type=glitch net=\dest_x[19] delays=(9,13)
  initial begin
    #9 \dest_x[19] = ~\dest_x[19];
    #13 \dest_x[19] = ~\dest_x[19];
  end
  // __INJECTED_FAULT__ type=glitch net=n246 delays=(6,11)
  initial begin
    #6 n246 = ~n246;
    #11 n246 = ~n246;
  end
