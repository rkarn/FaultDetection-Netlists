...
module c6288(N1, N18, N35, N52, N69, N86, N103, N120, N137, N154, N171,
  ...
  // __INJECTED_FAULT__ type=glitch net=N2085 delays=(4,5)
  initial begin
    #4 N2085 = ~N2085;
    #5 N2085 = ~N2085;
  end
  // __INJECTED_FAULT__ type=glitch net=N2414 delays=(15,17)
  initial begin
    #15 N2414 = ~N2414;
    #17 N2414 = ~N2414;
  end
  // __INJECTED_FAULT__ type=glitch net=N984 delays=(7,17)
  initial begin
    #7 N984 = ~N984;
    #17 N984 = ~N984;
  end
  // __INJECTED_FAULT__ type=glitch net=N4717 delays=(14,21)
  initial begin
    #14 N4717 = ~N4717;
    #21 N4717 = ~N4717;
  end
  // __INJECTED_FAULT__ type=glitch net=N3663 delays=(2,8)
  initial begin
    #2 N3663 = ~N3663;
    #8 N3663 = ~N3663;
  end
  // __INJECTED_FAULT__ type=glitch net=N3669 delays=(12,21)
  initial begin
    #12 N3669 = ~N3669;
    #21 N3669 = ~N3669;
  end
  // __INJECTED_FAULT__ type=glitch net=N4974 delays=(7,8)
  initial begin
    #7 N4974 = ~N4974;
    #8 N4974 = ~N4974;
  end
  // __INJECTED_FAULT__ type=glitch net=N3479 delays=(7,12)
  initial begin
    #7 N3479 = ~N3479;
    #12 N3479 = ~N3479;
  end
  // __INJECTED_FAULT__ type=glitch net=N2446 delays=(9,11)
  initial begin
    #9 N2446 = ~N2446;
    #11 N2446 = ~N2446;
  end
  // __INJECTED_FAULT__ type=glitch net=N1840 delays=(10,15)
  initial begin
    #10 N1840 = ~N1840;
    #15 N1840 = ~N1840;
  end
  // __INJECTED_FAULT__ type=glitch net=N1975 delays=(17,26)
  initial begin
    #17 N1975 = ~N1975;
    #26 N1975 = ~N1975;
  end
  // __INJECTED_FAULT__ type=glitch net=N2657 delays=(11,12)
  initial begin
    #11 N2657 = ~N2657;
    #12 N2657 = ~N2657;
  end
  // __INJECTED_FAULT__ type=glitch net=N239 delays=(4,10)
  initial begin
    #4 N239 = ~N239;
    #10 N239 = ~N239;
  end
  // __INJECTED_FAULT__ type=glitch net=N3140 delays=(11,18)
  initial begin
    #11 N3140 = ~N3140;
    #18 N3140 = ~N3140;
  end
  // __INJECTED_FAULT__ type=glitch net=N6170 delays=(19,29)
  initial begin
    #19 N6170 = ~N6170;
    #29 N6170 = ~N6170;
  end
  // __INJECTED_FAULT__ type=glitch net=N5092 delays=(1,4)
  initial begin
    #1 N5092 = ~N5092;
    #4 N5092 = ~N5092;
  end
  // __INJECTED_FAULT__ type=glitch net=N5464 delays=(7,13)
  initial begin
    #7 N5464 = ~N5464;
    #13 N5464 = ~N5464;
  end
  // __INJECTED_FAULT__ type=glitch net=N5473 delays=(11,19)
  initial begin
    #11 N5473 = ~N5473;
    #19 N5473 = ~N5473;
  end
  // __INJECTED_FAULT__ type=glitch net=N5907 delays=(16,17)
  initial begin
    #16 N5907 = ~N5907;
    #17 N5907 = ~N5907;
  end
  // __INJECTED_FAULT__ type=glitch net=N392 delays=(5,13)
  initial begin
    #5 N392 = ~N392;
    #13 N392 = ~N392;
  end
  // __INJECTED_FAULT__ type=glitch net=N5428 delays=(5,13)
  initial begin
    #5 N5428 = ~N5428;
    #13 N5428 = ~N5428;
  end
  // __INJECTED_FAULT__ type=glitch net=N2992 delays=(18,24)
  initial begin
    #18 N2992 = ~N2992;
    #24 N2992 = ~N2992;
  end
  // __INJECTED_FAULT__ type=glitch net=N2794 delays=(15,22)
  initial begin
    #15 N2794 = ~N2794;
    #22 N2794 = ~N2794;
  end
  // __INJECTED_FAULT__ type=glitch net=N5255 delays=(2,11)
  initial begin
    #2 N5255 = ~N5255;
    #11 N5255 = ~N5255;
  end
  // __INJECTED_FAULT__ type=glitch net=N5053 delays=(10,20)
  initial begin
    #10 N5053 = ~N5053;
    #20 N5053 = ~N5053;
  end
  // __INJECTED_FAULT__ type=glitch net=N4632 delays=(11,20)
  initial begin
    #11 N4632 = ~N4632;
    #20 N4632 = ~N4632;
  end
  // __INJECTED_FAULT__ type=glitch net=N4932 delays=(18,19)
  initial begin
    #18 N4932 = ~N4932;
    #19 N4932 = ~N4932;
  end
  // __INJECTED_FAULT__ type=glitch net=N1335 delays=(7,17)
  initial begin
    #7 N1335 = ~N1335;
    #17 N1335 = ~N1335;
  end
  // __INJECTED_FAULT__ type=glitch net=N443 delays=(11,17)
  initial begin
    #11 N443 = ~N443;
    #17 N443 = ~N443;
  end
  // __INJECTED_FAULT__ type=glitch net=N3040 delays=(3,6)
  initial begin
    #3 N3040 = ~N3040;
    #6 N3040 = ~N3040;
  end
  // __INJECTED_FAULT__ type=glitch net=N5938 delays=(9,10)
  initial begin
    #9 N5938 = ~N5938;
    #10 N5938 = ~N5938;
  end
  // __INJECTED_FAULT__ type=glitch net=N3360 delays=(11,18)
  initial begin
    #11 N3360 = ~N3360;
    #18 N3360 = ~N3360;
  end
  // __INJECTED_FAULT__ type=glitch net=N6036 delays=(18,21)
  initial begin
    #18 N6036 = ~N6036;
    #21 N6036 = ~N6036;
  end
  // __INJECTED_FAULT__ type=glitch net=N2682 delays=(19,29)
  initial begin
    #19 N2682 = ~N2682;
    #29 N2682 = ~N2682;
  end
  // __INJECTED_FAULT__ type=glitch net=N954 delays=(13,16)
  initial begin
    #13 N954 = ~N954;
    #16 N954 = ~N954;
  end
  // __INJECTED_FAULT__ type=glitch net=N2486 delays=(20,22)
  initial begin
    #20 N2486 = ~N2486;
    #22 N2486 = ~N2486;
  end
  // __INJECTED_FAULT__ type=glitch net=N2139 delays=(10,16)
  initial begin
    #10 N2139 = ~N2139;
    #16 N2139 = ~N2139;
  end
  // __INJECTED_FAULT__ type=glitch net=N1029 delays=(2,7)
  initial begin
    #2 N1029 = ~N1029;
    #7 N1029 = ~N1029;
  end
  // __INJECTED_FAULT__ type=glitch net=N4039 delays=(14,16)
  initial begin
    #14 N4039 = ~N4039;
    #16 N4039 = ~N4039;
  end
  // __INJECTED_FAULT__ type=glitch net=N804 delays=(16,20)
  initial begin
    #16 N804 = ~N804;
    #20 N804 = ~N804;
  end
  // __INJECTED_FAULT__ type=glitch net=N2097 delays=(12,20)
  initial begin
    #12 N2097 = ~N2097;
    #20 N2097 = ~N2097;
  end
  // __INJECTED_FAULT__ type=glitch net=N750 delays=(10,14)
  initial begin
    #10 N750 = ~N750;
    #14 N750 = ~N750;
  end
  // __INJECTED_FAULT__ type=glitch net=N6245 delays=(17,22)
  initial begin
    #17 N6245 = ~N6245;
    #22 N6245 = ~N6245;
  end
  // __INJECTED_FAULT__ type=glitch net=N3559 delays=(6,8)
  initial begin
    #6 N3559 = ~N3559;
    #8 N3559 = ~N3559;
  end
  // __INJECTED_FAULT__ type=glitch net=N3872 delays=(12,13)
  initial begin
    #12 N3872 = ~N3872;
    #13 N3872 = ~N3872;
  end
  // __INJECTED_FAULT__ type=glitch net=N1531 delays=(7,9)
  initial begin
    #7 N1531 = ~N1531;
    #9 N1531 = ~N1531;
  end
  // __INJECTED_FAULT__ type=glitch net=N1738 delays=(15,24)
  initial begin
    #15 N1738 = ~N1738;
    #24 N1738 = ~N1738;
  end
  // __INJECTED_FAULT__ type=glitch net=N4701 delays=(1,9)
  initial begin
    #1 N4701 = ~N4701;
    #9 N4701 = ~N4701;
  end
  // __INJECTED_FAULT__ type=glitch net=N2407 delays=(17,20)
  initial begin
    #17 N2407 = ~N2407;
    #20 N2407 = ~N2407;
  end
  // __INJECTED_FAULT__ type=glitch net=N2245 delays=(7,13)
  initial begin
    #7 N2245 = ~N2245;
    #13 N2245 = ~N2245;
  end
  // __INJECTED_FAULT__ type=glitch net=N3429 delays=(16,25)
  initial begin
    #16 N3429 = ~N3429;
    #25 N3429 = ~N3429;
  end
  // __INJECTED_FAULT__ type=glitch net=N6186 delays=(10,16)
  initial begin
    #10 N6186 = ~N6186;
    #16 N6186 = ~N6186;
  end
  // __INJECTED_FAULT__ type=glitch net=N6081 delays=(5,7)
  initial begin
    #5 N6081 = ~N6081;
    #7 N6081 = ~N6081;
  end
  // __INJECTED_FAULT__ type=glitch net=N2398 delays=(17,20)
  initial begin
    #17 N2398 = ~N2398;
    #20 N2398 = ~N2398;
  end
  // __INJECTED_FAULT__ type=glitch net=N5067 delays=(7,8)
  initial begin
    #7 N5067 = ~N5067;
    #8 N5067 = ~N5067;
  end
  // __INJECTED_FAULT__ type=glitch net=N6255 delays=(15,22)
  initial begin
    #15 N6255 = ~N6255;
    #22 N6255 = ~N6255;
  end
  // __INJECTED_FAULT__ type=glitch net=N4161 delays=(17,19)
  initial begin
    #17 N4161 = ~N4161;
    #19 N4161 = ~N4161;
  end
  // __INJECTED_FAULT__ type=glitch net=N792 delays=(1,6)
  initial begin
    #1 N792 = ~N792;
    #6 N792 = ~N792;
  end
  // __INJECTED_FAULT__ type=glitch net=N1588 delays=(2,12)
  initial begin
    #2 N1588 = ~N1588;
    #12 N1588 = ~N1588;
  end
  // __INJECTED_FAULT__ type=glitch net=N3568 delays=(3,9)
  initial begin
    #3 N3568 = ~N3568;
    #9 N3568 = ~N3568;
  end
  // __INJECTED_FAULT__ type=glitch net=N3805 delays=(15,16)
  initial begin
    #15 N3805 = ~N3805;
    #16 N3805 = ~N3805;
  end
  // __INJECTED_FAULT__ type=glitch net=N4226 delays=(4,13)
  initial begin
    #4 N4226 = ~N4226;
    #13 N4226 = ~N4226;
  end
  // __INJECTED_FAULT__ type=glitch net=N4341 delays=(10,11)
  initial begin
    #10 N4341 = ~N4341;
    #11 N4341 = ~N4341;
  end
  // __INJECTED_FAULT__ type=glitch net=N1185 delays=(19,24)
  initial begin
    #19 N1185 = ~N1185;
    #24 N1185 = ~N1185;
  end
  // __INJECTED_FAULT__ type=glitch net=N4793 delays=(7,13)
  initial begin
    #7 N4793 = ~N4793;
    #13 N4793 = ~N4793;
  end
  // __INJECTED_FAULT__ type=glitch net=N5968 delays=(7,11)
  initial begin
    #7 N5968 = ~N5968;
    #11 N5968 = ~N5968;
  end
  // __INJECTED_FAULT__ type=glitch net=N1149 delays=(10,15)
  initial begin
    #10 N1149 = ~N1149;
    #15 N1149 = ~N1149;
  end
  // __INJECTED_FAULT__ type=glitch net=N3506 delays=(18,24)
  initial begin
    #18 N3506 = ~N3506;
    #24 N3506 = ~N3506;
  end
  // __INJECTED_FAULT__ type=glitch net=N5215 delays=(15,17)
  initial begin
    #15 N5215 = ~N5215;
    #17 N5215 = ~N5215;
  end
  // __INJECTED_FAULT__ type=glitch net=N2008 delays=(9,12)
  initial begin
    #9 N2008 = ~N2008;
    #12 N2008 = ~N2008;
  end
  // __INJECTED_FAULT__ type=glitch net=N1870 delays=(6,11)
  initial begin
    #6 N1870 = ~N1870;
    #11 N1870 = ~N1870;
  end
  // __INJECTED_FAULT__ type=glitch net=N3333 delays=(4,5)
  initial begin
    #4 N3333 = ~N3333;
    #5 N3333 = ~N3333;
  end
  // __INJECTED_FAULT__ type=glitch net=N3855 delays=(20,29)
  initial begin
    #20 N3855 = ~N3855;
    #29 N3855 = ~N3855;
  end
  // __INJECTED_FAULT__ type=glitch net=N5749 delays=(17,19)
  initial begin
    #17 N5749 = ~N5749;
    #19 N5749 = ~N5749;
  end
  // __INJECTED_FAULT__ type=glitch net=N4671 delays=(7,16)
  initial begin
    #7 N4671 = ~N4671;
    #16 N4671 = ~N4671;
  end
  // __INJECTED_FAULT__ type=glitch net=N5726 delays=(12,21)
  initial begin
    #12 N5726 = ~N5726;
    #21 N5726 = ~N5726;
  end
  // __INJECTED_FAULT__ type=glitch net=N2706 delays=(11,16)
  initial begin
    #11 N2706 = ~N2706;
    #16 N2706 = ~N2706;
  end
  // __INJECTED_FAULT__ type=glitch net=N2697 delays=(5,10)
  initial begin
    #5 N2697 = ~N2697;
    #10 N2697 = ~N2697;
  end
  // __INJECTED_FAULT__ type=glitch net=N1068 delays=(19,23)
  initial begin
    #19 N1068 = ~N1068;
    #23 N1068 = ~N1068;
  end
  // __INJECTED_FAULT__ type=glitch net=N1741 delays=(6,8)
  initial begin
    #6 N1741 = ~N1741;
    #8 N1741 = ~N1741;
  end
  // __INJECTED_FAULT__ type=glitch net=N6176 delays=(10,20)
  initial begin
    #10 N6176 = ~N6176;
    #20 N6176 = ~N6176;
  end
  // __INJECTED_FAULT__ type=glitch net=N5769 delays=(11,20)
  initial begin
    #11 N5769 = ~N5769;
    #20 N5769 = ~N5769;
  end
  // __INJECTED_FAULT__ type=glitch net=N5336 delays=(15,16)
  initial begin
    #15 N5336 = ~N5336;
    #16 N5336 = ~N5336;
  end
  // __INJECTED_FAULT__ type=glitch net=N3466 delays=(5,6)
  initial begin
    #5 N3466 = ~N3466;
    #6 N3466 = ~N3466;
  end
  // __INJECTED_FAULT__ type=glitch net=N4792 delays=(16,17)
  initial begin
    #16 N4792 = ~N4792;
    #17 N4792 = ~N4792;
  end
  // __INJECTED_FAULT__ type=glitch net=N3734 delays=(4,11)
  initial begin
    #4 N3734 = ~N3734;
    #11 N3734 = ~N3734;
  end
  // __INJECTED_FAULT__ type=glitch net=N3185 delays=(2,4)
  initial begin
    #2 N3185 = ~N3185;
    #4 N3185 = ~N3185;
  end
  // __INJECTED_FAULT__ type=glitch net=N5738 delays=(14,21)
  initial begin
    #14 N5738 = ~N5738;
    #21 N5738 = ~N5738;
  end
  // __INJECTED_FAULT__ type=glitch net=N6215 delays=(6,16)
  initial begin
    #6 N6215 = ~N6215;
    #16 N6215 = ~N6215;
  end
  // __INJECTED_FAULT__ type=glitch net=N4090 delays=(19,27)
  initial begin
    #19 N4090 = ~N4090;
    #27 N4090 = ~N4090;
  end
  // __INJECTED_FAULT__ type=glitch net=N1947 delays=(20,26)
  initial begin
    #20 N1947 = ~N1947;
    #26 N1947 = ~N1947;
  end
  // __INJECTED_FAULT__ type=glitch net=N6085 delays=(10,16)
  initial begin
    #10 N6085 = ~N6085;
    #16 N6085 = ~N6085;
  end
  // __INJECTED_FAULT__ type=glitch net=N5452 delays=(7,16)
  initial begin
    #7 N5452 = ~N5452;
    #16 N5452 = ~N5452;
  end
  // __INJECTED_FAULT__ type=glitch net=N5679 delays=(3,11)
  initial begin
    #3 N5679 = ~N5679;
    #11 N5679 = ~N5679;
  end
  // __INJECTED_FAULT__ type=glitch net=N5422 delays=(19,22)
  initial begin
    #19 N5422 = ~N5422;
    #22 N5422 = ~N5422;
  end
  // __INJECTED_FAULT__ type=glitch net=N2430 delays=(3,11)
  initial begin
    #3 N2430 = ~N2430;
    #11 N2430 = ~N2430;
  end
  // __INJECTED_FAULT__ type=glitch net=N2938 delays=(4,12)
  initial begin
    #4 N2938 = ~N2938;
    #12 N2938 = ~N2938;
  end
  // __INJECTED_FAULT__ type=glitch net=N3490 delays=(10,18)
  initial begin
    #10 N3490 = ~N3490;
    #18 N3490 = ~N3490;
  end
  // __INJECTED_FAULT__ type=glitch net=N2549 delays=(16,20)
  initial begin
    #16 N2549 = ~N2549;
    #20 N2549 = ~N2549;
  end
  // __INJECTED_FAULT__ type=glitch net=N103 delays=(8,11)
  initial begin
    #8 N103 = ~N103;
    #11 N103 = ~N103;
  end
