...
module dec(\count[0] , \count[1] , \count[2] , \count[3] , \count[4] ,
  ...
  // __INJECTED_FAULT__ type=glitch net=\selectp1[16] delays=(3,4)
  initial begin
    #3 \selectp1[16] = ~\selectp1[16];
    #4 \selectp1[16] = ~\selectp1[16];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp1[55] delays=(14,17)
  initial begin
    #14 \selectp1[55] = ~\selectp1[55];
    #17 \selectp1[55] = ~\selectp1[55];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[93] delays=(16,20)
  initial begin
    #16 \selectp2[93] = ~\selectp2[93];
    #20 \selectp2[93] = ~\selectp2[93];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[16] delays=(15,17)
  initial begin
    #15 \selectp2[16] = ~\selectp2[16];
    #17 \selectp2[16] = ~\selectp2[16];
  end
  // __INJECTED_FAULT__ type=glitch net=n326 delays=(12,21)
  initial begin
    #12 n326 = ~n326;
    #21 n326 = ~n326;
  end
  // __INJECTED_FAULT__ type=glitch net=\count[2] delays=(13,23)
  initial begin
    #13 \count[2] = ~\count[2];
    #23 \count[2] = ~\count[2];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[96] delays=(18,27)
  initial begin
    #18 \selectp2[96] = ~\selectp2[96];
    #27 \selectp2[96] = ~\selectp2[96];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[37] delays=(13,18)
  initial begin
    #13 \selectp2[37] = ~\selectp2[37];
    #18 \selectp2[37] = ~\selectp2[37];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp1[112] delays=(19,27)
  initial begin
    #19 \selectp1[112] = ~\selectp1[112];
    #27 \selectp1[112] = ~\selectp1[112];
  end
  // __INJECTED_FAULT__ type=glitch net=n362 delays=(14,22)
  initial begin
    #14 n362 = ~n362;
    #22 n362 = ~n362;
  end
  // __INJECTED_FAULT__ type=glitch net=n304 delays=(16,23)
  initial begin
    #16 n304 = ~n304;
    #23 n304 = ~n304;
  end
  // __INJECTED_FAULT__ type=glitch net=n276 delays=(6,9)
  initial begin
    #6 n276 = ~n276;
    #9 n276 = ~n276;
  end
  // __INJECTED_FAULT__ type=glitch net=n449 delays=(17,20)
  initial begin
    #17 n449 = ~n449;
    #20 n449 = ~n449;
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp1[111] delays=(16,24)
  initial begin
    #16 \selectp1[111] = ~\selectp1[111];
    #24 \selectp1[111] = ~\selectp1[111];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[43] delays=(5,14)
  initial begin
    #5 \selectp2[43] = ~\selectp2[43];
    #14 \selectp2[43] = ~\selectp2[43];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[17] delays=(17,19)
  initial begin
    #17 \selectp2[17] = ~\selectp2[17];
    #19 \selectp2[17] = ~\selectp2[17];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[9] delays=(7,15)
  initial begin
    #7 \selectp2[9] = ~\selectp2[9];
    #15 \selectp2[9] = ~\selectp2[9];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp1[63] delays=(16,17)
  initial begin
    #16 \selectp1[63] = ~\selectp1[63];
    #17 \selectp1[63] = ~\selectp1[63];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[57] delays=(6,15)
  initial begin
    #6 \selectp2[57] = ~\selectp2[57];
    #15 \selectp2[57] = ~\selectp2[57];
  end
  // __INJECTED_FAULT__ type=glitch net=n267 delays=(12,14)
  initial begin
    #12 n267 = ~n267;
    #14 n267 = ~n267;
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp1[118] delays=(20,27)
  initial begin
    #20 \selectp1[118] = ~\selectp1[118];
    #27 \selectp1[118] = ~\selectp1[118];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp1[45] delays=(4,6)
  initial begin
    #4 \selectp1[45] = ~\selectp1[45];
    #6 \selectp1[45] = ~\selectp1[45];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[31] delays=(12,22)
  initial begin
    #12 \selectp2[31] = ~\selectp2[31];
    #22 \selectp2[31] = ~\selectp2[31];
  end
  // __INJECTED_FAULT__ type=glitch net=n265 delays=(10,11)
  initial begin
    #10 n265 = ~n265;
    #11 n265 = ~n265;
  end
  // __INJECTED_FAULT__ type=glitch net=n363 delays=(17,20)
  initial begin
    #17 n363 = ~n363;
    #20 n363 = ~n363;
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp1[90] delays=(4,10)
  initial begin
    #4 \selectp1[90] = ~\selectp1[90];
    #10 \selectp1[90] = ~\selectp1[90];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[48] delays=(10,16)
  initial begin
    #10 \selectp2[48] = ~\selectp2[48];
    #16 \selectp2[48] = ~\selectp2[48];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp1[42] delays=(10,15)
  initial begin
    #10 \selectp1[42] = ~\selectp1[42];
    #15 \selectp1[42] = ~\selectp1[42];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp1[67] delays=(16,17)
  initial begin
    #16 \selectp1[67] = ~\selectp1[67];
    #17 \selectp1[67] = ~\selectp1[67];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[81] delays=(5,8)
  initial begin
    #5 \selectp2[81] = ~\selectp2[81];
    #8 \selectp2[81] = ~\selectp2[81];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp2[74] delays=(19,26)
  initial begin
    #19 \selectp2[74] = ~\selectp2[74];
    #26 \selectp2[74] = ~\selectp2[74];
  end
  // __INJECTED_FAULT__ type=glitch net=\selectp1[33] delays=(2,7)
  initial begin
    #2 \selectp1[33] = ~\selectp1[33];
    #7 \selectp1[33] = ~\selectp1[33];
  end
endmodule
