...
module c1908(N1, N4, N7, N10, N13, N16, N19, N22, N25, N28, N31, N34,
  ...
  not g51 (N923, N926);
  // __INJECTED_FAULT__ type=glitch net=n_83 delays=(10,15)
  initial begin
    #10 n_83 = ~n_83;
    #15 n_83 = ~n_83;
  end
  // __INJECTED_FAULT__ type=glitch net=N2543 delays=(11,13)
  initial begin
    #11 N2543 = ~N2543;
    #13 N2543 = ~N2543;
  end
  // __INJECTED_FAULT__ type=glitch net=N1852 delays=(18,26)
  initial begin
    #18 N1852 = ~N1852;
    #26 N1852 = ~N1852;
  end
  // __INJECTED_FAULT__ type=glitch net=N1387 delays=(1,7)
  initial begin
    #1 N1387 = ~N1387;
    #7 N1387 = ~N1387;
  end
  // __INJECTED_FAULT__ type=glitch net=N2631 delays=(7,12)
  initial begin
    #7 N2631 = ~N2631;
    #12 N2631 = ~N2631;
  end
  // __INJECTED_FAULT__ type=glitch net=N1150 delays=(19,24)
  initial begin
    #19 N1150 = ~N1150;
    #24 N1150 = ~N1150;
  end
  // __INJECTED_FAULT__ type=glitch net=N1898 delays=(20,24)
  initial begin
    #20 N1898 = ~N1898;
    #24 N1898 = ~N1898;
  end
  // __INJECTED_FAULT__ type=glitch net=N1120 delays=(15,21)
  initial begin
    #15 N1120 = ~N1120;
    #21 N1120 = ~N1120;
  end
  // __INJECTED_FAULT__ type=glitch net=N94 delays=(19,27)
  initial begin
    #19 N94 = ~N94;
    #27 N94 = ~N94;
  end
  // __INJECTED_FAULT__ type=glitch net=N2279 delays=(7,16)
  initial begin
    #7 N2279 = ~N2279;
    #16 N2279 = ~N2279;
  end
  // __INJECTED_FAULT__ type=glitch net=N2760 delays=(8,11)
  initial begin
    #8 N2760 = ~N2760;
    #11 N2760 = ~N2760;
  end
  // __INJECTED_FAULT__ type=glitch net=N1912 delays=(1,8)
  initial begin
    #1 N1912 = ~N1912;
    #8 N1912 = ~N1912;
  end
  // __INJECTED_FAULT__ type=glitch net=N216 delays=(1,5)
  initial begin
    #1 N216 = ~N216;
    #5 N216 = ~N216;
  end
  // __INJECTED_FAULT__ type=glitch net=N1878 delays=(18,24)
  initial begin
    #18 N1878 = ~N1878;
    #24 N1878 = ~N1878;
  end
  // __INJECTED_FAULT__ type=glitch net=N266 delays=(1,7)
  initial begin
    #1 N266 = ~N266;
    #7 N266 = ~N266;
  end
  // __INJECTED_FAULT__ type=glitch net=N2853 delays=(1,8)
  initial begin
    #1 N2853 = ~N2853;
    #8 N2853 = ~N2853;
  end
  // __INJECTED_FAULT__ type=glitch net=N2597 delays=(10,12)
  initial begin
    #10 N2597 = ~N2597;
    #12 N2597 = ~N2597;
  end
  // __INJECTED_FAULT__ type=glitch net=N2892 delays=(7,16)
  initial begin
    #7 N2892 = ~N2892;
    #16 N2892 = ~N2892;
  end
  // __INJECTED_FAULT__ type=glitch net=n_86 delays=(8,15)
  initial begin
    #8 n_86 = ~n_86;
    #15 n_86 = ~n_86;
  end
  // __INJECTED_FAULT__ type=glitch net=N2627 delays=(16,17)
  initial begin
    #16 N2627 = ~N2627;
    #17 N2627 = ~N2627;
  end
  // __INJECTED_FAULT__ type=glitch net=N1346 delays=(5,10)
  initial begin
    #5 N1346 = ~N1346;
    #10 N1346 = ~N1346;
  end
  // __INJECTED_FAULT__ type=glitch net=N1830 delays=(3,4)
  initial begin
    #3 N1830 = ~N1830;
    #4 N1830 = ~N1830;
  end
  // __INJECTED_FAULT__ type=glitch net=N903 delays=(8,17)
  initial begin
    #8 N903 = ~N903;
    #17 N903 = ~N903;
  end
  // __INJECTED_FAULT__ type=glitch net=N1068 delays=(14,20)
  initial begin
    #14 N1068 = ~N1068;
    #20 N1068 = ~N1068;
  end
  // __INJECTED_FAULT__ type=glitch net=N1706 delays=(15,17)
  initial begin
    #15 N1706 = ~N1706;
    #17 N1706 = ~N1706;
  end
  // __INJECTED_FAULT__ type=glitch net=N7 delays=(19,21)
  initial begin
    #19 N7 = ~N7;
    #21 N7 = ~N7;
  end
  // __INJECTED_FAULT__ type=glitch net=N2784 delays=(17,20)
  initial begin
    #17 N2784 = ~N2784;
    #20 N2784 = ~N2784;
  end
  // __INJECTED_FAULT__ type=glitch net=N37 delays=(13,15)
  initial begin
    #13 N37 = ~N37;
    #15 N37 = ~N37;
  end
  // __INJECTED_FAULT__ type=glitch net=N1795 delays=(19,29)
  initial begin
    #19 N1795 = ~N1795;
    #29 N1795 = ~N1795;
  end
  // __INJECTED_FAULT__ type=glitch net=N2786 delays=(2,9)
  initial begin
    #2 N2786 = ~N2786;
    #9 N2786 = ~N2786;
  end
  // __INJECTED_FAULT__ type=glitch net=N2874 delays=(5,9)
  initial begin
    #5 N2874 = ~N2874;
    #9 N2874 = ~N2874;
  end
  // __INJECTED_FAULT__ type=glitch net=N2611 delays=(10,15)
  initial begin
    #10 N2611 = ~N2611;
    #15 N2611 = ~N2611;
  end
  // __INJECTED_FAULT__ type=glitch net=N2664 delays=(11,18)
  initial begin
    #11 N2664 = ~N2664;
    #18 N2664 = ~N2664;
  end
  // __INJECTED_FAULT__ type=glitch net=N1311 delays=(11,17)
  initial begin
    #11 N1311 = ~N1311;
    #17 N1311 = ~N1311;
  end
  // __INJECTED_FAULT__ type=glitch net=N1443 delays=(15,20)
  initial begin
    #15 N1443 = ~N1443;
    #20 N1443 = ~N1443;
  end
  // __INJECTED_FAULT__ type=glitch net=N2756 delays=(8,10)
  initial begin
    #8 N2756 = ~N2756;
    #10 N2756 = ~N2756;
  end
  // __INJECTED_FAULT__ type=glitch net=N2742 delays=(7,10)
  initial begin
    #7 N2742 = ~N2742;
    #10 N2742 = ~N2742;
  end
  // __INJECTED_FAULT__ type=glitch net=N1672 delays=(19,21)
  initial begin
    #19 N1672 = ~N1672;
    #21 N1672 = ~N1672;
  end
  // __INJECTED_FAULT__ type=glitch net=N2223 delays=(5,7)
  initial begin
    #5 N2223 = ~N2223;
    #7 N2223 = ~N2223;
  end
  // __INJECTED_FAULT__ type=glitch net=N1802 delays=(6,14)
  initial begin
    #6 N1802 = ~N1802;
    #14 N1802 = ~N1802;
  end
  // __INJECTED_FAULT__ type=glitch net=N2739 delays=(15,21)
  initial begin
    #15 N2739 = ~N2739;
    #21 N2739 = ~N2739;
  end
  // __INJECTED_FAULT__ type=glitch net=N2215 delays=(14,16)
  initial begin
    #14 N2215 = ~N2215;
    #16 N2215 = ~N2215;
  end
  // __INJECTED_FAULT__ type=glitch net=N1911 delays=(18,24)
  initial begin
    #18 N1911 = ~N1911;
    #24 N1911 = ~N1911;
  end
  // __INJECTED_FAULT__ type=glitch net=N269 delays=(7,15)
  initial begin
    #7 N269 = ~N269;
    #15 N269 = ~N269;
  end
  // __INJECTED_FAULT__ type=glitch net=N2632 delays=(10,18)
  initial begin
    #10 N2632 = ~N2632;
    #18 N2632 = ~N2632;
  end
  // __INJECTED_FAULT__ type=glitch net=N1122 delays=(9,11)
  initial begin
    #9 N1122 = ~N1122;
    #11 N1122 = ~N1122;
  end
  // __INJECTED_FAULT__ type=glitch net=N2889 delays=(3,6)
  initial begin
    #3 N2889 = ~N2889;
    #6 N2889 = ~N2889;
  end
  // __INJECTED_FAULT__ type=glitch net=N1671 delays=(10,20)
  initial begin
    #10 N1671 = ~N1671;
    #20 N1671 = ~N1671;
  end
  // __INJECTED_FAULT__ type=glitch net=N2723 delays=(2,6)
  initial begin
    #2 N2723 = ~N2723;
    #6 N2723 = ~N2723;
  end
  // __INJECTED_FAULT__ type=glitch net=N235 delays=(11,14)
  initial begin
    #11 N235 = ~N235;
    #14 N235 = ~N235;
  end
  // __INJECTED_FAULT__ type=glitch net=N2867 delays=(3,7)
  initial begin
    #3 N2867 = ~N2867;
    #7 N2867 = ~N2867;
  end
