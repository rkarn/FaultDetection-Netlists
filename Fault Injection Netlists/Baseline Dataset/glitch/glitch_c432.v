...
module c432(N1, N4, N8, N11, N14, N17, N21, N24, N27, N30, N34, N37,
  ...
  // __INJECTED_FAULT__ type=glitch net=N371 delays=(12,16)
  initial begin
    #12 N371 = ~N371;
    #16 N371 = ~N371;
  end
  // __INJECTED_FAULT__ type=glitch net=N300 delays=(1,4)
  initial begin
    #1 N300 = ~N300;
    #4 N300 = ~N300;
  end
  // __INJECTED_FAULT__ type=glitch net=N273 delays=(3,8)
  initial begin
    #3 N273 = ~N273;
    #8 N273 = ~N273;
  end
  // __INJECTED_FAULT__ type=glitch net=N8 delays=(13,19)
  initial begin
    #13 N8 = ~N8;
    #19 N8 = ~N8;
  end
  // __INJECTED_FAULT__ type=glitch net=N134 delays=(13,20)
  initial begin
    #13 N134 = ~N134;
    #20 N134 = ~N134;
  end
  // __INJECTED_FAULT__ type=glitch net=N376 delays=(19,23)
  initial begin
    #19 N376 = ~N376;
    #23 N376 = ~N376;
  end
  // __INJECTED_FAULT__ type=glitch net=n_58 delays=(17,18)
  initial begin
    #17 n_58 = ~n_58;
    #18 n_58 = ~n_58;
  end
  // __INJECTED_FAULT__ type=glitch net=N306 delays=(3,5)
  initial begin
    #3 N306 = ~N306;
    #5 N306 = ~N306;
  end
  // __INJECTED_FAULT__ type=glitch net=N184 delays=(18,23)
  initial begin
    #18 N184 = ~N184;
    #23 N184 = ~N184;
  end
  // __INJECTED_FAULT__ type=glitch net=N130 delays=(18,28)
  initial begin
    #18 N130 = ~N130;
    #28 N130 = ~N130;
  end
  // __INJECTED_FAULT__ type=glitch net=N27 delays=(12,18)
  initial begin
    #12 N27 = ~N27;
    #18 N27 = ~N27;
  end
  // __INJECTED_FAULT__ type=glitch net=n_53 delays=(9,13)
  initial begin
    #9 n_53 = ~n_53;
    #13 n_53 = ~n_53;
  end
  // __INJECTED_FAULT__ type=glitch net=N348 delays=(20,24)
  initial begin
    #20 N348 = ~N348;
    #24 N348 = ~N348;
  end
  // __INJECTED_FAULT__ type=glitch net=N304 delays=(15,22)
  initial begin
    #15 N304 = ~N304;
    #22 N304 = ~N304;
  end
  // __INJECTED_FAULT__ type=glitch net=N407 delays=(19,20)
  initial begin
    #19 N407 = ~N407;
    #20 N407 = ~N407;
  end
  // __INJECTED_FAULT__ type=glitch net=N150 delays=(9,12)
  initial begin
    #9 N150 = ~N150;
    #12 N150 = ~N150;
  end
  // __INJECTED_FAULT__ type=glitch net=N352 delays=(14,23)
  initial begin
    #14 N352 = ~N352;
    #23 N352 = ~N352;
  end
  // __INJECTED_FAULT__ type=glitch net=N118 delays=(4,13)
  initial begin
    #4 N118 = ~N118;
    #13 N118 = ~N118;
  end
  // __INJECTED_FAULT__ type=glitch net=N380 delays=(3,12)
  initial begin
    #3 N380 = ~N380;
    #12 N380 = ~N380;
  end
  // __INJECTED_FAULT__ type=glitch net=N30 delays=(10,16)
  initial begin
    #10 N30 = ~N30;
    #16 N30 = ~N30;
  end
