...
module dec(\count[0] , \count[1] , \count[2] , \count[3] , \count[4] ,
  ...
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=1 net=n_11 delays=(1,10)
  initial begin
    #1 n_11 = ~n_11;
    #9 n_11 = ~n_11;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=2 net=n483 delays=(9,19)
  initial begin
    #9 n483 = ~n483;
    #10 n483 = ~n483;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=3 net=n_6 delays=(5,12)
  initial begin
    #5 n_6 = ~n_6;
    #7 n_6 = ~n_6;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=4 net=n280 delays=(7,14)
  initial begin
    #7 n280 = ~n280;
    #7 n280 = ~n280;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=5 net=n_16 delays=(1,3)
  initial begin
    #1 n_16 = ~n_16;
    #2 n_16 = ~n_16;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=6 net=n267 delays=(6,11)
  initial begin
    #6 n267 = ~n267;
    #5 n267 = ~n267;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=7 net=n308 delays=(16,20)
  initial begin
    #16 n308 = ~n308;
    #4 n308 = ~n308;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=8 net=n_3 delays=(9,11)
  initial begin
    #9 n_3 = ~n_3;
    #2 n_3 = ~n_3;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=9 net=n309 delays=(5,14)
  initial begin
    #5 n309 = ~n309;
    #9 n309 = ~n309;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=10 net=n269 delays=(9,13)
  initial begin
    #9 n269 = ~n269;
    #4 n269 = ~n269;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=11 net=n302 delays=(14,20)
  initial begin
    #14 n302 = ~n302;
    #6 n302 = ~n302;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=12 net=n_10 delays=(4,7)
  initial begin
    #4 n_10 = ~n_10;
    #3 n_10 = ~n_10;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=13 net=n284 delays=(1,2)
  initial begin
    #1 n284 = ~n284;
    #1 n284 = ~n284;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=14 net=n293 delays=(7,13)
  initial begin
    #7 n293 = ~n293;
    #6 n293 = ~n293;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=15 net=n268 delays=(20,22)
  initial begin
    #20 n268 = ~n268;
    #2 n268 = ~n268;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=16 net=n500 delays=(9,17)
  initial begin
    #9 n500 = ~n500;
    #8 n500 = ~n500;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=17 net=n501 delays=(1,3)
  initial begin
    #1 n501 = ~n501;
    #2 n501 = ~n501;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=18 net=n298 delays=(8,15)
  initial begin
    #8 n298 = ~n298;
    #7 n298 = ~n298;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=19 net=n306 delays=(8,13)
  initial begin
    #8 n306 = ~n306;
    #5 n306 = ~n306;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=20 net=n286 delays=(14,20)
  initial begin
    #14 n286 = ~n286;
    #6 n286 = ~n286;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=21 net=n266 delays=(3,7)
  initial begin
    #3 n266 = ~n266;
    #4 n266 = ~n266;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=22 net=n326 delays=(1,3)
  initial begin
    #1 n326 = ~n326;
    #2 n326 = ~n326;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=23 net=n291 delays=(19,20)
  initial begin
    #19 n291 = ~n291;
    #1 n291 = ~n291;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=24 net=n275 delays=(12,13)
  initial begin
    #12 n275 = ~n275;
    #1 n275 = ~n275;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=25 net=n327 delays=(2,10)
  initial begin
    #2 n327 = ~n327;
    #8 n327 = ~n327;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=26 net=n296 delays=(8,13)
  initial begin
    #8 n296 = ~n296;
    #5 n296 = ~n296;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=27 net=n273 delays=(3,8)
  initial begin
    #3 n273 = ~n273;
    #5 n273 = ~n273;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=28 net=n552 delays=(12,13)
  initial begin
    #12 n552 = ~n552;
    #1 n552 = ~n552;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=29 net=n272 delays=(13,20)
  initial begin
    #13 n272 = ~n272;
    #7 n272 = ~n272;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=30 net=n345 delays=(8,17)
  initial begin
    #8 n345 = ~n345;
    #9 n345 = ~n345;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=31 net=n281 delays=(9,13)
  initial begin
    #9 n281 = ~n281;
    #4 n281 = ~n281;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=32 net=n431 delays=(17,20)
  initial begin
    #17 n431 = ~n431;
    #3 n431 = ~n431;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=33 net=n265 delays=(20,23)
  initial begin
    #20 n265 = ~n265;
    #3 n265 = ~n265;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=34 net=n380 delays=(4,10)
  initial begin
    #4 n380 = ~n380;
    #6 n380 = ~n380;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=35 net=n278 delays=(15,20)
  initial begin
    #15 n278 = ~n278;
    #5 n278 = ~n278;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=36 net=n432 delays=(8,14)
  initial begin
    #8 n432 = ~n432;
    #6 n432 = ~n432;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=37 net=n283 delays=(2,9)
  initial begin
    #2 n283 = ~n283;
    #7 n283 = ~n283;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=38 net=n362 delays=(20,23)
  initial begin
    #20 n362 = ~n362;
    #3 n362 = ~n362;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=39 net=n276 delays=(15,22)
  initial begin
    #15 n276 = ~n276;
    #7 n276 = ~n276;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=40 net=n_4 delays=(9,11)
  initial begin
    #9 n_4 = ~n_4;
    #2 n_4 = ~n_4;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=41 net=n449 delays=(5,12)
  initial begin
    #5 n449 = ~n449;
    #7 n449 = ~n449;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=42 net=n288 delays=(16,19)
  initial begin
    #16 n288 = ~n288;
    #3 n288 = ~n288;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=43 net=n304 delays=(6,10)
  initial begin
    #6 n304 = ~n304;
    #4 n304 = ~n304;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=44 net=n_14 delays=(20,25)
  initial begin
    #20 n_14 = ~n_14;
    #5 n_14 = ~n_14;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=45 net=n344 delays=(3,10)
  initial begin
    #3 n344 = ~n344;
    #7 n344 = ~n344;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=46 net=n397 delays=(17,23)
  initial begin
    #17 n397 = ~n397;
    #6 n397 = ~n397;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=47 net=n466 delays=(3,8)
  initial begin
    #3 n466 = ~n466;
    #5 n466 = ~n466;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=48 net=n290 delays=(4,9)
  initial begin
    #4 n290 = ~n290;
    #5 n290 = ~n290;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=49 net=n535 delays=(13,23)
  initial begin
    #13 n535 = ~n535;
    #10 n535 = ~n535;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=50 net=n414 delays=(8,13)
  initial begin
    #8 n414 = ~n414;
    #5 n414 = ~n414;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=51 net=n270 delays=(5,14)
  initial begin
    #5 n270 = ~n270;
    #9 n270 = ~n270;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=52 net=n_15 delays=(18,20)
  initial begin
    #18 n_15 = ~n_15;
    #2 n_15 = ~n_15;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=53 net=n518 delays=(2,11)
  initial begin
    #2 n518 = ~n518;
    #9 n518 = ~n518;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=54 net=n363 delays=(13,23)
  initial begin
    #13 n363 = ~n363;
    #10 n363 = ~n363;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=55 net=n300 delays=(11,18)
  initial begin
    #11 n300 = ~n300;
    #7 n300 = ~n300;
  end
  // __INJECTED_FAULT__ range=500-1000 type=glitch id=56 net=n295 delays=(7,17)
  initial begin
    #7 n295 = ~n295;
    #10 n295 = ~n295;
  end
