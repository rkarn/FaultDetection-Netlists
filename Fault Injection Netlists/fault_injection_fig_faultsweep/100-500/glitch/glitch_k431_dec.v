...
module dec(\count[0] , \count[1] , \count[2] , \count[3] , \count[4] ,
  ...
  // __INJECTED_FAULT__ range=100-500 type=glitch id=1 net=n_3 delays=(8,9)
  initial begin
    #8 n_3 = ~n_3;
    #1 n_3 = ~n_3;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=2 net=n345 delays=(11,16)
  initial begin
    #11 n345 = ~n345;
    #5 n345 = ~n345;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=3 net=n397 delays=(15,18)
  initial begin
    #15 n397 = ~n397;
    #3 n397 = ~n397;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=4 net=n266 delays=(11,12)
  initial begin
    #11 n266 = ~n266;
    #1 n266 = ~n266;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=5 net=n466 delays=(7,9)
  initial begin
    #7 n466 = ~n466;
    #2 n466 = ~n466;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=6 net=n_11 delays=(12,14)
  initial begin
    #12 n_11 = ~n_11;
    #2 n_11 = ~n_11;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=7 net=n283 delays=(2,7)
  initial begin
    #2 n283 = ~n283;
    #5 n283 = ~n283;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=8 net=n380 delays=(13,22)
  initial begin
    #13 n380 = ~n380;
    #9 n380 = ~n380;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=9 net=n414 delays=(1,9)
  initial begin
    #1 n414 = ~n414;
    #8 n414 = ~n414;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=10 net=n276 delays=(7,14)
  initial begin
    #7 n276 = ~n276;
    #7 n276 = ~n276;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=11 net=n449 delays=(13,17)
  initial begin
    #13 n449 = ~n449;
    #4 n449 = ~n449;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=12 net=n344 delays=(16,20)
  initial begin
    #16 n344 = ~n344;
    #4 n344 = ~n344;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=13 net=n295 delays=(20,30)
  initial begin
    #20 n295 = ~n295;
    #10 n295 = ~n295;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=14 net=n363 delays=(15,24)
  initial begin
    #15 n363 = ~n363;
    #9 n363 = ~n363;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=15 net=n275 delays=(4,12)
  initial begin
    #4 n275 = ~n275;
    #8 n275 = ~n275;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=16 net=n306 delays=(16,19)
  initial begin
    #16 n306 = ~n306;
    #3 n306 = ~n306;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=17 net=n302 delays=(20,27)
  initial begin
    #20 n302 = ~n302;
    #7 n302 = ~n302;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=18 net=n535 delays=(13,22)
  initial begin
    #13 n535 = ~n535;
    #9 n535 = ~n535;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=19 net=n296 delays=(2,5)
  initial begin
    #2 n296 = ~n296;
    #3 n296 = ~n296;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=20 net=n286 delays=(8,12)
  initial begin
    #8 n286 = ~n286;
    #4 n286 = ~n286;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=21 net=n268 delays=(16,23)
  initial begin
    #16 n268 = ~n268;
    #7 n268 = ~n268;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=22 net=n304 delays=(13,20)
  initial begin
    #13 n304 = ~n304;
    #7 n304 = ~n304;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=23 net=n308 delays=(17,22)
  initial begin
    #17 n308 = ~n308;
    #5 n308 = ~n308;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=24 net=n309 delays=(16,24)
  initial begin
    #16 n309 = ~n309;
    #8 n309 = ~n309;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=25 net=n326 delays=(11,14)
  initial begin
    #11 n326 = ~n326;
    #3 n326 = ~n326;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=26 net=n300 delays=(7,10)
  initial begin
    #7 n300 = ~n300;
    #3 n300 = ~n300;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=27 net=n518 delays=(13,21)
  initial begin
    #13 n518 = ~n518;
    #8 n518 = ~n518;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=28 net=n270 delays=(6,16)
  initial begin
    #6 n270 = ~n270;
    #10 n270 = ~n270;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=29 net=n552 delays=(6,9)
  initial begin
    #6 n552 = ~n552;
    #3 n552 = ~n552;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=30 net=n432 delays=(9,12)
  initial begin
    #9 n432 = ~n432;
    #3 n432 = ~n432;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=31 net=n362 delays=(15,18)
  initial begin
    #15 n362 = ~n362;
    #3 n362 = ~n362;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=32 net=n_15 delays=(15,19)
  initial begin
    #15 n_15 = ~n_15;
    #4 n_15 = ~n_15;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=33 net=n327 delays=(12,18)
  initial begin
    #12 n327 = ~n327;
    #6 n327 = ~n327;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=34 net=n431 delays=(16,23)
  initial begin
    #16 n431 = ~n431;
    #7 n431 = ~n431;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=35 net=n_6 delays=(16,22)
  initial begin
    #16 n_6 = ~n_6;
    #6 n_6 = ~n_6;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=36 net=n_4 delays=(19,24)
  initial begin
    #19 n_4 = ~n_4;
    #5 n_4 = ~n_4;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=37 net=n501 delays=(19,21)
  initial begin
    #19 n501 = ~n501;
    #2 n501 = ~n501;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=38 net=n288 delays=(10,14)
  initial begin
    #10 n288 = ~n288;
    #4 n288 = ~n288;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=39 net=n280 delays=(1,11)
  initial begin
    #1 n280 = ~n280;
    #10 n280 = ~n280;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=40 net=n281 delays=(1,4)
  initial begin
    #1 n281 = ~n281;
    #3 n281 = ~n281;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=41 net=n483 delays=(10,14)
  initial begin
    #10 n483 = ~n483;
    #4 n483 = ~n483;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=42 net=n284 delays=(19,26)
  initial begin
    #19 n284 = ~n284;
    #7 n284 = ~n284;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=43 net=n265 delays=(2,4)
  initial begin
    #2 n265 = ~n265;
    #2 n265 = ~n265;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=44 net=n267 delays=(16,21)
  initial begin
    #16 n267 = ~n267;
    #5 n267 = ~n267;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=45 net=n278 delays=(9,18)
  initial begin
    #9 n278 = ~n278;
    #9 n278 = ~n278;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=46 net=n290 delays=(18,19)
  initial begin
    #18 n290 = ~n290;
    #1 n290 = ~n290;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=47 net=n269 delays=(3,10)
  initial begin
    #3 n269 = ~n269;
    #7 n269 = ~n269;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=48 net=n291 delays=(8,14)
  initial begin
    #8 n291 = ~n291;
    #6 n291 = ~n291;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=49 net=n_16 delays=(14,22)
  initial begin
    #14 n_16 = ~n_16;
    #8 n_16 = ~n_16;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=50 net=n273 delays=(4,9)
  initial begin
    #4 n273 = ~n273;
    #5 n273 = ~n273;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=51 net=n293 delays=(5,8)
  initial begin
    #5 n293 = ~n293;
    #3 n293 = ~n293;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=52 net=n272 delays=(18,27)
  initial begin
    #18 n272 = ~n272;
    #9 n272 = ~n272;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=53 net=n_10 delays=(2,6)
  initial begin
    #2 n_10 = ~n_10;
    #4 n_10 = ~n_10;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=54 net=n500 delays=(2,11)
  initial begin
    #2 n500 = ~n500;
    #9 n500 = ~n500;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=55 net=n_14 delays=(4,12)
  initial begin
    #4 n_14 = ~n_14;
    #8 n_14 = ~n_14;
  end
  // __INJECTED_FAULT__ range=100-500 type=glitch id=56 net=n298 delays=(10,11)
  initial begin
    #10 n298 = ~n298;
    #1 n298 = ~n298;
  end
