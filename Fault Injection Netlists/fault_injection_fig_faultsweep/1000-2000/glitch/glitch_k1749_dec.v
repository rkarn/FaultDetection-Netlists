...
module dec(\count[0] , \count[1] , \count[2] , \count[3] , \count[4] ,
  ...
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=1 net=n309 delays=(9,10)
  initial begin
    #9 n309 = ~n309;
    #1 n309 = ~n309;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=2 net=n272 delays=(2,8)
  initial begin
    #2 n272 = ~n272;
    #6 n272 = ~n272;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=3 net=n275 delays=(12,19)
  initial begin
    #12 n275 = ~n275;
    #7 n275 = ~n275;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=4 net=n_16 delays=(14,16)
  initial begin
    #14 n_16 = ~n_16;
    #2 n_16 = ~n_16;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=5 net=n500 delays=(7,10)
  initial begin
    #7 n500 = ~n500;
    #3 n500 = ~n500;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=6 net=n_10 delays=(7,9)
  initial begin
    #7 n_10 = ~n_10;
    #2 n_10 = ~n_10;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=7 net=n300 delays=(15,21)
  initial begin
    #15 n300 = ~n300;
    #6 n300 = ~n300;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=8 net=n270 delays=(14,23)
  initial begin
    #14 n270 = ~n270;
    #9 n270 = ~n270;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=9 net=n_6 delays=(8,14)
  initial begin
    #8 n_6 = ~n_6;
    #6 n_6 = ~n_6;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=10 net=n269 delays=(17,20)
  initial begin
    #17 n269 = ~n269;
    #3 n269 = ~n269;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=11 net=n414 delays=(19,26)
  initial begin
    #19 n414 = ~n414;
    #7 n414 = ~n414;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=12 net=n290 delays=(19,20)
  initial begin
    #19 n290 = ~n290;
    #1 n290 = ~n290;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=13 net=n380 delays=(5,11)
  initial begin
    #5 n380 = ~n380;
    #6 n380 = ~n380;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=14 net=n_3 delays=(17,20)
  initial begin
    #17 n_3 = ~n_3;
    #3 n_3 = ~n_3;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=15 net=n281 delays=(17,23)
  initial begin
    #17 n281 = ~n281;
    #6 n281 = ~n281;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=16 net=n344 delays=(10,11)
  initial begin
    #10 n344 = ~n344;
    #1 n344 = ~n344;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=17 net=n288 delays=(7,17)
  initial begin
    #7 n288 = ~n288;
    #10 n288 = ~n288;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=18 net=n327 delays=(12,21)
  initial begin
    #12 n327 = ~n327;
    #9 n327 = ~n327;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=19 net=n432 delays=(7,11)
  initial begin
    #7 n432 = ~n432;
    #4 n432 = ~n432;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=20 net=n304 delays=(8,12)
  initial begin
    #8 n304 = ~n304;
    #4 n304 = ~n304;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=21 net=n308 delays=(1,7)
  initial begin
    #1 n308 = ~n308;
    #6 n308 = ~n308;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=22 net=n268 delays=(7,12)
  initial begin
    #7 n268 = ~n268;
    #5 n268 = ~n268;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=23 net=n278 delays=(6,10)
  initial begin
    #6 n278 = ~n278;
    #4 n278 = ~n278;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=24 net=n552 delays=(15,22)
  initial begin
    #15 n552 = ~n552;
    #7 n552 = ~n552;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=25 net=n291 delays=(1,6)
  initial begin
    #1 n291 = ~n291;
    #5 n291 = ~n291;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=26 net=n276 delays=(13,14)
  initial begin
    #13 n276 = ~n276;
    #1 n276 = ~n276;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=27 net=n267 delays=(14,15)
  initial begin
    #14 n267 = ~n267;
    #1 n267 = ~n267;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=28 net=n286 delays=(18,25)
  initial begin
    #18 n286 = ~n286;
    #7 n286 = ~n286;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=29 net=n501 delays=(4,13)
  initial begin
    #4 n501 = ~n501;
    #9 n501 = ~n501;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=30 net=n_14 delays=(8,13)
  initial begin
    #8 n_14 = ~n_14;
    #5 n_14 = ~n_14;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=31 net=n298 delays=(3,13)
  initial begin
    #3 n298 = ~n298;
    #10 n298 = ~n298;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=32 net=n431 delays=(2,3)
  initial begin
    #2 n431 = ~n431;
    #1 n431 = ~n431;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=33 net=n284 delays=(7,16)
  initial begin
    #7 n284 = ~n284;
    #9 n284 = ~n284;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=34 net=n273 delays=(6,8)
  initial begin
    #6 n273 = ~n273;
    #2 n273 = ~n273;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=35 net=n293 delays=(6,10)
  initial begin
    #6 n293 = ~n293;
    #4 n293 = ~n293;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=36 net=n280 delays=(20,24)
  initial begin
    #20 n280 = ~n280;
    #4 n280 = ~n280;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=37 net=n535 delays=(6,9)
  initial begin
    #6 n535 = ~n535;
    #3 n535 = ~n535;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=38 net=n_11 delays=(20,22)
  initial begin
    #20 n_11 = ~n_11;
    #2 n_11 = ~n_11;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=39 net=n306 delays=(7,13)
  initial begin
    #7 n306 = ~n306;
    #6 n306 = ~n306;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=40 net=n_4 delays=(4,5)
  initial begin
    #4 n_4 = ~n_4;
    #1 n_4 = ~n_4;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=41 net=n362 delays=(16,24)
  initial begin
    #16 n362 = ~n362;
    #8 n362 = ~n362;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=42 net=n_15 delays=(17,18)
  initial begin
    #17 n_15 = ~n_15;
    #1 n_15 = ~n_15;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=43 net=n302 delays=(16,26)
  initial begin
    #16 n302 = ~n302;
    #10 n302 = ~n302;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=44 net=n449 delays=(14,20)
  initial begin
    #14 n449 = ~n449;
    #6 n449 = ~n449;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=45 net=n266 delays=(10,19)
  initial begin
    #10 n266 = ~n266;
    #9 n266 = ~n266;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=46 net=n326 delays=(18,19)
  initial begin
    #18 n326 = ~n326;
    #1 n326 = ~n326;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=47 net=n483 delays=(11,18)
  initial begin
    #11 n483 = ~n483;
    #7 n483 = ~n483;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=48 net=n283 delays=(18,25)
  initial begin
    #18 n283 = ~n283;
    #7 n283 = ~n283;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=49 net=n363 delays=(8,16)
  initial begin
    #8 n363 = ~n363;
    #8 n363 = ~n363;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=50 net=n296 delays=(17,21)
  initial begin
    #17 n296 = ~n296;
    #4 n296 = ~n296;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=51 net=n518 delays=(2,12)
  initial begin
    #2 n518 = ~n518;
    #10 n518 = ~n518;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=52 net=n345 delays=(5,8)
  initial begin
    #5 n345 = ~n345;
    #3 n345 = ~n345;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=53 net=n295 delays=(18,27)
  initial begin
    #18 n295 = ~n295;
    #9 n295 = ~n295;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=54 net=n397 delays=(14,20)
  initial begin
    #14 n397 = ~n397;
    #6 n397 = ~n397;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=55 net=n466 delays=(11,12)
  initial begin
    #11 n466 = ~n466;
    #1 n466 = ~n466;
  end
  // __INJECTED_FAULT__ range=1000-2000 type=glitch id=56 net=n265 delays=(18,21)
  initial begin
    #18 n265 = ~n265;
    #3 n265 = ~n265;
  end
